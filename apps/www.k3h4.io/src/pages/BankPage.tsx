            ...
            <div className="pointer-events-none absolute inset-0">
                <R3FErrorBoundary>
                    <Canvas dpr={[1, 2]} camera={{ position: [0, 0, 9], fov: 45 }} gl={{ antialias: true, alpha: false }}>
                        ...
                        <Stars radius={140} depth={110} count={1800} factor={1.0} saturation={0.06} fade speed={0.28} />
                        <Stars radius={90} depth={70} count={1200} factor={0.82} saturation={0.08} fade speed={0.42} />
                    </Canvas>
                </R3FErrorBoundary>
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(16,185,129,0.12),transparent_45%),radial-gradient(circle_at_80%_10%,rgba(59,130,246,0.12),transparent_40%),radial-gradient(circle_at_70%_80%,rgba(236,72,153,0.12),transparent_40%)]" />
            </div>
                                        ...
                                        {sortedTransactions.length === 0 ? (
                                            ...
                                            sortedTransactions.map((tx) => (
                                                <tr key={tx.id} className="transition hover:bg-white/5">
                                                    ...
                                                    <td className="px-3 py-2 text-sm text-slate-200">{tx.note ?? "--"}</td>
                                                </tr>
                                            ))
                                        )}
                                    </tbody>
