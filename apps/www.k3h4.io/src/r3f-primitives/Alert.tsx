...
const toneMap: Record<NonNullable<AlertProps["tone"]>, { bg: string; border: string; dot: string }> = {
...
export function Alert({ position = [0, 1.1, 0], width = 320, title, description, tone = "info", className = "" }: AlertProps) {
