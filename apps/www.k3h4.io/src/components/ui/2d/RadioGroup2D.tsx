export type RadioOption2D = {
    key: string;
    label: string;
    description?: string;
};

export type RadioGroup2DProps = {
    name: string;
    options: RadioOption2D[];
    value?: string;
    onValueChange?: (key: string) => void;
    className?: string;
};

export function RadioGroup2D({ name, options, value, onValueChange, className = "" }: RadioGroup2DProps) {
    return (
