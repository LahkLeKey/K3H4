...
export function registerActorEntityRoutes(
  ...
  const registerActorRoutes = (scope: FastifyInstance) => {
    ...
    scope.get('/actors', auth, async (request) => {
    ...
    scope.post('/actors', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
    ...
    scope.get('/actors/:id', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
    ...
    scope.patch('/actors/:id', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
      const params = request.params as {id?: string};
      const actorId = normalizeString(params?.id);
    ...
    scope.delete('/actors/:id', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
      const params = request.params as {id?: string};
      const actorId = normalizeString(params?.id);
    ...
    scope.get('/actors/:actorId/entities', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
    ...
    scope.post('/actors/:actorId/entities', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
      const params = request.params as {actorId?: string};
      const actorId = normalizeString(params?.actorId);
  ...
  const registerEntityRoutes = (scope: FastifyInstance) => {
    ...
    scope.get('/entities/:id', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
      const params = request.params as {id?: string};
    ...
    scope.patch('/entities/:id', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
      const params = request.params as {id?: string};
      const entityId = normalizeString(params?.id);
    ...
    scope.delete('/entities/:id', auth, async (request, reply) => {
      const rt = withTelemetryBase(recordTelemetry, request);
      const userId = (request.user as {sub: string}).sub;
      const params = request.params as {id?: string};
      const entityId = normalizeString(params?.id);
