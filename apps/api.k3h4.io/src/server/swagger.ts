...
export const swaggerTags: Record<string, { name: string; description: string }> = {
  ...
  pos: { name: "POS", description: describe.pos },
...
export const swaggerTagMap: Record<string, { name: string; description: string }> = {
...
export const docsStaticDir = path.join(process.cwd(), "public", "docs", "static");

export const buildOpenApiOptions = (resolveServerUrl: () => string): SwaggerOptions => ({
  openapi: {
    openapi: "3.0.0",
    info: {
      title: "K3H4 API",
