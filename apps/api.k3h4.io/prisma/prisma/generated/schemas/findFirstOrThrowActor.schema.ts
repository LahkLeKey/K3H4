...
export const ActorFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ActorSelect> = z.object({
...
export const ActorFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const ActorFindFirstOrThrowSchema: z.ZodType<Prisma.ActorFindFirstOrThrowArgs> = z.object({ select: ActorFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ActorIncludeObjectSchema.optional()), orderBy: z.union([ActorOrderByWithRelationInputObjectSchema, ActorOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActorWhereInputObjectSchema.optional(), cursor: ActorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActorScalarFieldEnumSchema, ActorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActorFindFirstOrThrowArgs>;

export const ActorFindFirstOrThrowZodSchema = z.object({ select: ActorFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ActorIncludeObjectSchema.optional()), orderBy: z.union([ActorOrderByWithRelationInputObjectSchema, ActorOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActorWhereInputObjectSchema.optional(), cursor: ActorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActorScalarFieldEnumSchema, ActorScalarFieldEnumSchema.array()]).optional() }).strict();