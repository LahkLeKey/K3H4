...
export const RefreshTokenFindManySchema: z.ZodType<Prisma.RefreshTokenFindManyArgs> = z.object({ select: RefreshTokenFindManySelectSchema.optional(), include: z.lazy(() => RefreshTokenIncludeObjectSchema.optional()), orderBy: z.union([RefreshTokenOrderByWithRelationInputObjectSchema, RefreshTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: RefreshTokenWhereInputObjectSchema.optional(), cursor: RefreshTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RefreshTokenScalarFieldEnumSchema, RefreshTokenScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RefreshTokenFindManyArgs>;

export const RefreshTokenFindManyZodSchema = z.object({ select: RefreshTokenFindManySelectSchema.optional(), include: z.lazy(() => RefreshTokenIncludeObjectSchema.optional()), orderBy: z.union([RefreshTokenOrderByWithRelationInputObjectSchema, RefreshTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: RefreshTokenWhereInputObjectSchema.optional(), cursor: RefreshTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RefreshTokenScalarFieldEnumSchema, RefreshTokenScalarFieldEnumSchema.array()]).optional() }).strict();