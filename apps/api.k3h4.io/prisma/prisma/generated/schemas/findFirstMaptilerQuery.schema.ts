...
export const MaptilerQueryFindFirstSelectSchema: z.ZodType<Prisma.MaptilerQuerySelect> = z.object({
...
export const MaptilerQueryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    actorId: z.boolean().optional(),
...
export const MaptilerQueryFindFirstSchema: z.ZodType<Prisma.MaptilerQueryFindFirstArgs> = z.object({ select: MaptilerQueryFindFirstSelectSchema.optional(), include: z.lazy(() => MaptilerQueryIncludeObjectSchema.optional()), orderBy: z.union([MaptilerQueryOrderByWithRelationInputObjectSchema, MaptilerQueryOrderByWithRelationInputObjectSchema.array()]).optional(), where: MaptilerQueryWhereInputObjectSchema.optional(), cursor: MaptilerQueryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaptilerQueryScalarFieldEnumSchema, MaptilerQueryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MaptilerQueryFindFirstArgs>;

export const MaptilerQueryFindFirstZodSchema = z.object({ select: MaptilerQueryFindFirstSelectSchema.optional(), include: z.lazy(() => MaptilerQueryIncludeObjectSchema.optional()), orderBy: z.union([MaptilerQueryOrderByWithRelationInputObjectSchema, MaptilerQueryOrderByWithRelationInputObjectSchema.array()]).optional(), where: MaptilerQueryWhereInputObjectSchema.optional(), cursor: MaptilerQueryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaptilerQueryScalarFieldEnumSchema, MaptilerQueryScalarFieldEnumSchema.array()]).optional() }).strict();