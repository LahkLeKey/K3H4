...
export const PoiEnrichmentCacheFindFirstSelectSchema: z.ZodType<Prisma.PoiEnrichmentCacheSelect> = z.object({
...
export const PoiEnrichmentCacheFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    includeHash: z.boolean().optional(),
    payload: z.boolean().optional(),
    fetchedAt: z.boolean().optional(),
