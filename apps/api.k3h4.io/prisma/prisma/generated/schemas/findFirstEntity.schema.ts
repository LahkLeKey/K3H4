...
export const EntityFindFirstSelectSchema: z.ZodType<Prisma.EntitySelect> = z.object({
...
export const EntityFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    actorId: z.boolean().optional(),
    actor: z.boolean().optional(),
    kind: z.boolean().optional(),
...
export const EntityFindFirstSchema: z.ZodType<Prisma.EntityFindFirstArgs> = z.object({ select: EntityFindFirstSelectSchema.optional(), include: z.lazy(() => EntityIncludeObjectSchema.optional()), orderBy: z.union([EntityOrderByWithRelationInputObjectSchema, EntityOrderByWithRelationInputObjectSchema.array()]).optional(), where: EntityWhereInputObjectSchema.optional(), cursor: EntityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EntityScalarFieldEnumSchema, EntityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EntityFindFirstArgs>;

export const EntityFindFirstZodSchema = z.object({ select: EntityFindFirstSelectSchema.optional(), include: z.lazy(() => EntityIncludeObjectSchema.optional()), orderBy: z.union([EntityOrderByWithRelationInputObjectSchema, EntityOrderByWithRelationInputObjectSchema.array()]).optional(), where: EntityWhereInputObjectSchema.optional(), cursor: EntityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EntityScalarFieldEnumSchema, EntityScalarFieldEnumSchema.array()]).optional() }).strict();