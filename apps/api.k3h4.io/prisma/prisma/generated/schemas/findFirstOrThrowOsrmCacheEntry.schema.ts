...
export const OsrmCacheEntryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.OsrmCacheEntrySelect> = z.object({
...
export const OsrmCacheEntryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    service: z.boolean().optional(),
...
export const OsrmCacheEntryFindFirstOrThrowSchema: z.ZodType<Prisma.OsrmCacheEntryFindFirstOrThrowArgs> = z.object({ select: OsrmCacheEntryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OsrmCacheEntryIncludeObjectSchema.optional()), orderBy: z.union([OsrmCacheEntryOrderByWithRelationInputObjectSchema, OsrmCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: OsrmCacheEntryWhereInputObjectSchema.optional(), cursor: OsrmCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OsrmCacheEntryScalarFieldEnumSchema, OsrmCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OsrmCacheEntryFindFirstOrThrowArgs>;

export const OsrmCacheEntryFindFirstOrThrowZodSchema = z.object({ select: OsrmCacheEntryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OsrmCacheEntryIncludeObjectSchema.optional()), orderBy: z.union([OsrmCacheEntryOrderByWithRelationInputObjectSchema, OsrmCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: OsrmCacheEntryWhereInputObjectSchema.optional(), cursor: OsrmCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OsrmCacheEntryScalarFieldEnumSchema, OsrmCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();