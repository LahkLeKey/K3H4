...
export const EntityFindManySelectSchema: z.ZodType<Prisma.EntitySelect> = z.object({
...
export const EntityFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    actorId: z.boolean().optional(),
    actor: z.boolean().optional(),
    kind: z.boolean().optional(),
...
export const EntityFindManySchema: z.ZodType<Prisma.EntityFindManyArgs> = z.object({ select: EntityFindManySelectSchema.optional(), include: z.lazy(() => EntityIncludeObjectSchema.optional()), orderBy: z.union([EntityOrderByWithRelationInputObjectSchema, EntityOrderByWithRelationInputObjectSchema.array()]).optional(), where: EntityWhereInputObjectSchema.optional(), cursor: EntityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EntityScalarFieldEnumSchema, EntityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EntityFindManyArgs>;

export const EntityFindManyZodSchema = z.object({ select: EntityFindManySelectSchema.optional(), include: z.lazy(() => EntityIncludeObjectSchema.optional()), orderBy: z.union([EntityOrderByWithRelationInputObjectSchema, EntityOrderByWithRelationInputObjectSchema.array()]).optional(), where: EntityWhereInputObjectSchema.optional(), cursor: EntityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EntityScalarFieldEnumSchema, EntityScalarFieldEnumSchema.array()]).optional() }).strict();