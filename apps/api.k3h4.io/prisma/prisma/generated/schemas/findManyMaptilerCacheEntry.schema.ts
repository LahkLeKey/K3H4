...
export const MaptilerCacheEntryFindManySelectSchema: z.ZodType<Prisma.MaptilerCacheEntrySelect> = z.object({
...
export const MaptilerCacheEntryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    queryId: z.boolean().optional(),
...
export const MaptilerCacheEntryFindManySchema: z.ZodType<Prisma.MaptilerCacheEntryFindManyArgs> = z.object({ select: MaptilerCacheEntryFindManySelectSchema.optional(), include: z.lazy(() => MaptilerCacheEntryIncludeObjectSchema.optional()), orderBy: z.union([MaptilerCacheEntryOrderByWithRelationInputObjectSchema, MaptilerCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: MaptilerCacheEntryWhereInputObjectSchema.optional(), cursor: MaptilerCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaptilerCacheEntryScalarFieldEnumSchema, MaptilerCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MaptilerCacheEntryFindManyArgs>;

export const MaptilerCacheEntryFindManyZodSchema = z.object({ select: MaptilerCacheEntryFindManySelectSchema.optional(), include: z.lazy(() => MaptilerCacheEntryIncludeObjectSchema.optional()), orderBy: z.union([MaptilerCacheEntryOrderByWithRelationInputObjectSchema, MaptilerCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: MaptilerCacheEntryWhereInputObjectSchema.optional(), cursor: MaptilerCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaptilerCacheEntryScalarFieldEnumSchema, MaptilerCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();