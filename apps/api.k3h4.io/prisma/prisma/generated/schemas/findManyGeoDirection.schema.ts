...
export const GeoDirectionFindManySelectSchema: z.ZodType<Prisma.GeoDirectionSelect> = z.object({
...
export const GeoDirectionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    provider: z.boolean().optional(),
...
export const GeoDirectionFindManySchema: z.ZodType<Prisma.GeoDirectionFindManyArgs> = z.object({ select: GeoDirectionFindManySelectSchema.optional(), include: z.lazy(() => GeoDirectionIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionOrderByWithRelationInputObjectSchema, GeoDirectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionWhereInputObjectSchema.optional(), cursor: GeoDirectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionScalarFieldEnumSchema, GeoDirectionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoDirectionFindManyArgs>;

export const GeoDirectionFindManyZodSchema = z.object({ select: GeoDirectionFindManySelectSchema.optional(), include: z.lazy(() => GeoDirectionIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionOrderByWithRelationInputObjectSchema, GeoDirectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionWhereInputObjectSchema.optional(), cursor: GeoDirectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionScalarFieldEnumSchema, GeoDirectionScalarFieldEnumSchema.array()]).optional() }).strict();