...
export const ChatSessionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ChatSessionSelect> = z.object({
...
export const ChatSessionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    title: z.boolean().optional(),
...
export const ChatSessionFindFirstOrThrowSchema: z.ZodType<Prisma.ChatSessionFindFirstOrThrowArgs> = z.object({ select: ChatSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ChatSessionIncludeObjectSchema.optional()), orderBy: z.union([ChatSessionOrderByWithRelationInputObjectSchema, ChatSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChatSessionWhereInputObjectSchema.optional(), cursor: ChatSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChatSessionScalarFieldEnumSchema, ChatSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ChatSessionFindFirstOrThrowArgs>;

export const ChatSessionFindFirstOrThrowZodSchema = z.object({ select: ChatSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ChatSessionIncludeObjectSchema.optional()), orderBy: z.union([ChatSessionOrderByWithRelationInputObjectSchema, ChatSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChatSessionWhereInputObjectSchema.optional(), cursor: ChatSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChatSessionScalarFieldEnumSchema, ChatSessionScalarFieldEnumSchema.array()]).optional() }).strict();