...
const makeSchema = () => z.object({
  create: z.union([z.lazy(() => UserCreateWithoutRefreshTokensInputObjectSchema), z.lazy(() => UserUncheckedCreateWithoutRefreshTokensInputObjectSchema)]).optional(),
  ...
  update: z.union([z.lazy(() => UserUpdateToOneWithWhereWithoutRefreshTokensInputObjectSchema), z.lazy(() => UserUpdateWithoutRefreshTokensInputObjectSchema), z.lazy(() => UserUncheckedUpdateWithoutRefreshTokensInputObjectSchema)]).optional()
}).strict();
export const UserUpdateOneRequiredWithoutRefreshTokensNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutRefreshTokensNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutRefreshTokensNestedInput>;
export const UserUpdateOneRequiredWithoutRefreshTokensNestedInputObjectZodSchema = makeSchema();
