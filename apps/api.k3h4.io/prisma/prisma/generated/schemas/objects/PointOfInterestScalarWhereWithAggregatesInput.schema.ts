...
const pointofinterestscalarwherewithaggregatesinputSchema = z.object({
  AND: z.union([z.lazy(() => PointOfInterestScalarWhereWithAggregatesInputObjectSchema), z.lazy(() => PointOfInterestScalarWhereWithAggregatesInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => PointOfInterestScalarWhereWithAggregatesInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => PointOfInterestScalarWhereWithAggregatesInputObjectSchema), z.lazy(() => PointOfInterestScalarWhereWithAggregatesInputObjectSchema).array()]).optional(),
...
export const PointOfInterestScalarWhereWithAggregatesInputObjectSchema: z.ZodType<Prisma.PointOfInterestScalarWhereWithAggregatesInput> = pointofinterestscalarwherewithaggregatesinputSchema as unknown as z.ZodType<Prisma.PointOfInterestScalarWhereWithAggregatesInput>;
export const PointOfInterestScalarWhereWithAggregatesInputObjectZodSchema = pointofinterestscalarwherewithaggregatesinputSchema;
