...
export const GeoDirectionSegmentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GeoDirectionSegmentSelect> = z.object({
...
export const GeoDirectionSegmentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    directionId: z.boolean().optional(),
    direction: z.boolean().optional(),
    sequence: z.boolean().optional(),
...
export const GeoDirectionSegmentFindFirstOrThrowSchema: z.ZodType<Prisma.GeoDirectionSegmentFindFirstOrThrowArgs> = z.object({ select: GeoDirectionSegmentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GeoDirectionSegmentIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionSegmentOrderByWithRelationInputObjectSchema, GeoDirectionSegmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionSegmentWhereInputObjectSchema.optional(), cursor: GeoDirectionSegmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionSegmentScalarFieldEnumSchema, GeoDirectionSegmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoDirectionSegmentFindFirstOrThrowArgs>;

export const GeoDirectionSegmentFindFirstOrThrowZodSchema = z.object({ select: GeoDirectionSegmentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GeoDirectionSegmentIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionSegmentOrderByWithRelationInputObjectSchema, GeoDirectionSegmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionSegmentWhereInputObjectSchema.optional(), cursor: GeoDirectionSegmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionSegmentScalarFieldEnumSchema, GeoDirectionSegmentScalarFieldEnumSchema.array()]).optional() }).strict();