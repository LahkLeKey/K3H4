...
export const ActorFindFirstSelectSchema: z.ZodType<Prisma.ActorSelect> = z.object({
...
export const ActorFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const ActorFindFirstSchema: z.ZodType<Prisma.ActorFindFirstArgs> = z.object({ select: ActorFindFirstSelectSchema.optional(), include: z.lazy(() => ActorIncludeObjectSchema.optional()), orderBy: z.union([ActorOrderByWithRelationInputObjectSchema, ActorOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActorWhereInputObjectSchema.optional(), cursor: ActorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActorScalarFieldEnumSchema, ActorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActorFindFirstArgs>;

export const ActorFindFirstZodSchema = z.object({ select: ActorFindFirstSelectSchema.optional(), include: z.lazy(() => ActorIncludeObjectSchema.optional()), orderBy: z.union([ActorOrderByWithRelationInputObjectSchema, ActorOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActorWhereInputObjectSchema.optional(), cursor: ActorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActorScalarFieldEnumSchema, ActorScalarFieldEnumSchema.array()]).optional() }).strict();