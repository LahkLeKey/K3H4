...
export const GeoDirectionFindFirstSelectSchema: z.ZodType<Prisma.GeoDirectionSelect> = z.object({
...
export const GeoDirectionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    actorId: z.boolean().optional(),
...
export const GeoDirectionFindFirstSchema: z.ZodType<Prisma.GeoDirectionFindFirstArgs> = z.object({ select: GeoDirectionFindFirstSelectSchema.optional(), include: z.lazy(() => GeoDirectionIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionOrderByWithRelationInputObjectSchema, GeoDirectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionWhereInputObjectSchema.optional(), cursor: GeoDirectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionScalarFieldEnumSchema, GeoDirectionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoDirectionFindFirstArgs>;

export const GeoDirectionFindFirstZodSchema = z.object({ select: GeoDirectionFindFirstSelectSchema.optional(), include: z.lazy(() => GeoDirectionIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionOrderByWithRelationInputObjectSchema, GeoDirectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionWhereInputObjectSchema.optional(), cursor: GeoDirectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionScalarFieldEnumSchema, GeoDirectionScalarFieldEnumSchema.array()]).optional() }).strict();