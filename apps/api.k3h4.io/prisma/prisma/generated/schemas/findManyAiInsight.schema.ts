...
export const AiInsightFindManySelectSchema: z.ZodType<Prisma.AiInsightSelect> = z.object({
...
export const AiInsightFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    targetType: z.boolean().optional(),
...
export const AiInsightFindManySchema: z.ZodType<Prisma.AiInsightFindManyArgs> = z.object({ select: AiInsightFindManySelectSchema.optional(), include: z.lazy(() => AiInsightIncludeObjectSchema.optional()), orderBy: z.union([AiInsightOrderByWithRelationInputObjectSchema, AiInsightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AiInsightWhereInputObjectSchema.optional(), cursor: AiInsightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AiInsightScalarFieldEnumSchema, AiInsightScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AiInsightFindManyArgs>;

export const AiInsightFindManyZodSchema = z.object({ select: AiInsightFindManySelectSchema.optional(), include: z.lazy(() => AiInsightIncludeObjectSchema.optional()), orderBy: z.union([AiInsightOrderByWithRelationInputObjectSchema, AiInsightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AiInsightWhereInputObjectSchema.optional(), cursor: AiInsightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AiInsightScalarFieldEnumSchema, AiInsightScalarFieldEnumSchema.array()]).optional() }).strict();