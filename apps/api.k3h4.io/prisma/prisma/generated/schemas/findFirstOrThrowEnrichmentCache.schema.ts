...
export const EnrichmentCacheFindFirstOrThrowSelectSchema: z.ZodType<Prisma.EnrichmentCacheSelect> = z.object({
...
export const EnrichmentCacheFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    provider: z.boolean().optional(),
    namespace: z.boolean().optional(),
    kind: z.boolean().optional(),
...
export const EnrichmentCacheFindFirstOrThrowSchema: z.ZodType<Prisma.EnrichmentCacheFindFirstOrThrowArgs> = z.object({ select: EnrichmentCacheFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([EnrichmentCacheOrderByWithRelationInputObjectSchema, EnrichmentCacheOrderByWithRelationInputObjectSchema.array()]).optional(), where: EnrichmentCacheWhereInputObjectSchema.optional(), cursor: EnrichmentCacheWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EnrichmentCacheScalarFieldEnumSchema, EnrichmentCacheScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EnrichmentCacheFindFirstOrThrowArgs>;

export const EnrichmentCacheFindFirstOrThrowZodSchema = z.object({ select: EnrichmentCacheFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([EnrichmentCacheOrderByWithRelationInputObjectSchema, EnrichmentCacheOrderByWithRelationInputObjectSchema.array()]).optional(), where: EnrichmentCacheWhereInputObjectSchema.optional(), cursor: EnrichmentCacheWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EnrichmentCacheScalarFieldEnumSchema, EnrichmentCacheScalarFieldEnumSchema.array()]).optional() }).strict();