...
export const BuildingFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BuildingSelect> = z.object({
...
export const BuildingFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    osmId: z.boolean().optional(),
    type: z.boolean().optional(),
    addressHouseNumber: z.boolean().optional(),
...
export const BuildingFindFirstOrThrowSchema: z.ZodType<Prisma.BuildingFindFirstOrThrowArgs> = z.object({ select: BuildingFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BuildingIncludeObjectSchema.optional()), orderBy: z.union([BuildingOrderByWithRelationInputObjectSchema, BuildingOrderByWithRelationInputObjectSchema.array()]).optional(), where: BuildingWhereInputObjectSchema.optional(), cursor: BuildingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BuildingScalarFieldEnumSchema, BuildingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BuildingFindFirstOrThrowArgs>;

export const BuildingFindFirstOrThrowZodSchema = z.object({ select: BuildingFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BuildingIncludeObjectSchema.optional()), orderBy: z.union([BuildingOrderByWithRelationInputObjectSchema, BuildingOrderByWithRelationInputObjectSchema.array()]).optional(), where: BuildingWhereInputObjectSchema.optional(), cursor: BuildingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BuildingScalarFieldEnumSchema, BuildingScalarFieldEnumSchema.array()]).optional() }).strict();