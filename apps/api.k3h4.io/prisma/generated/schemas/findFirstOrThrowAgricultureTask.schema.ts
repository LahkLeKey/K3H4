...
export const AgricultureTaskFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AgricultureTaskSelect> = z.object({
...
export const AgricultureTaskFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    plotId: z.boolean().optional(),
...
export const AgricultureTaskFindFirstOrThrowSchema: z.ZodType<Prisma.AgricultureTaskFindFirstOrThrowArgs> = z.object({ select: AgricultureTaskFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgricultureTaskIncludeObjectSchema.optional()), orderBy: z.union([AgricultureTaskOrderByWithRelationInputObjectSchema, AgricultureTaskOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureTaskWhereInputObjectSchema.optional(), cursor: AgricultureTaskWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureTaskScalarFieldEnumSchema, AgricultureTaskScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgricultureTaskFindFirstOrThrowArgs>;

export const AgricultureTaskFindFirstOrThrowZodSchema = z.object({ select: AgricultureTaskFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgricultureTaskIncludeObjectSchema.optional()), orderBy: z.union([AgricultureTaskOrderByWithRelationInputObjectSchema, AgricultureTaskOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureTaskWhereInputObjectSchema.optional(), cursor: AgricultureTaskWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureTaskScalarFieldEnumSchema, AgricultureTaskScalarFieldEnumSchema.array()]).optional() }).strict();