...
export const StaffingEngagementFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StaffingEngagementSelect> = z.object({
...
export const StaffingEngagementFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const StaffingEngagementFindFirstOrThrowSchema: z.ZodType<Prisma.StaffingEngagementFindFirstOrThrowArgs> = z.object({ select: StaffingEngagementFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StaffingEngagementIncludeObjectSchema.optional()), orderBy: z.union([StaffingEngagementOrderByWithRelationInputObjectSchema, StaffingEngagementOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingEngagementWhereInputObjectSchema.optional(), cursor: StaffingEngagementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingEngagementScalarFieldEnumSchema, StaffingEngagementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffingEngagementFindFirstOrThrowArgs>;

export const StaffingEngagementFindFirstOrThrowZodSchema = z.object({ select: StaffingEngagementFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StaffingEngagementIncludeObjectSchema.optional()), orderBy: z.union([StaffingEngagementOrderByWithRelationInputObjectSchema, StaffingEngagementOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingEngagementWhereInputObjectSchema.optional(), cursor: StaffingEngagementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingEngagementScalarFieldEnumSchema, StaffingEngagementScalarFieldEnumSchema.array()]).optional() }).strict();