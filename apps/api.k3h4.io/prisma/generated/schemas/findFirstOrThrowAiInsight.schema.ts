...
export const AiInsightFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AiInsightSelect> = z.object({
...
export const AiInsightFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    targetType: z.boolean().optional(),
...
export const AiInsightFindFirstOrThrowSchema: z.ZodType<Prisma.AiInsightFindFirstOrThrowArgs> = z.object({ select: AiInsightFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AiInsightIncludeObjectSchema.optional()), orderBy: z.union([AiInsightOrderByWithRelationInputObjectSchema, AiInsightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AiInsightWhereInputObjectSchema.optional(), cursor: AiInsightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AiInsightScalarFieldEnumSchema, AiInsightScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AiInsightFindFirstOrThrowArgs>;

export const AiInsightFindFirstOrThrowZodSchema = z.object({ select: AiInsightFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AiInsightIncludeObjectSchema.optional()), orderBy: z.union([AiInsightOrderByWithRelationInputObjectSchema, AiInsightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AiInsightWhereInputObjectSchema.optional(), cursor: AiInsightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AiInsightScalarFieldEnumSchema, AiInsightScalarFieldEnumSchema.array()]).optional() }).strict();