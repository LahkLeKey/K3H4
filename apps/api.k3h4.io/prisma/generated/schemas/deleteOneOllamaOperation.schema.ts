...
export const OllamaOperationDeleteOneSchema: z.ZodType<Prisma.OllamaOperationDeleteArgs> = z.object({ select: OllamaOperationSelectObjectSchema.optional(), include: OllamaOperationIncludeObjectSchema.optional(), where: OllamaOperationWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.OllamaOperationDeleteArgs>;

export const OllamaOperationDeleteOneZodSchema = z.object({ select: OllamaOperationSelectObjectSchema.optional(), include: OllamaOperationIncludeObjectSchema.optional(), where: OllamaOperationWhereUniqueInputObjectSchema }).strict();