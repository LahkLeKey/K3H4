...
export const UsdaRegionFindManySelectSchema: z.ZodType<Prisma.UsdaRegionSelect> = z.object({
...
export const UsdaRegionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
