...
export const AssignmentTimecardFindUniqueSchema: z.ZodType<Prisma.AssignmentTimecardFindUniqueArgs> = z.object({ select: AssignmentTimecardSelectObjectSchema.optional(), include: AssignmentTimecardIncludeObjectSchema.optional(), where: AssignmentTimecardWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.AssignmentTimecardFindUniqueArgs>;

export const AssignmentTimecardFindUniqueZodSchema = z.object({ select: AssignmentTimecardSelectObjectSchema.optional(), include: AssignmentTimecardIncludeObjectSchema.optional(), where: AssignmentTimecardWhereUniqueInputObjectSchema }).strict();