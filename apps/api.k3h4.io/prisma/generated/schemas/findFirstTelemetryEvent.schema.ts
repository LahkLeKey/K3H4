...
export const TelemetryEventFindFirstSelectSchema: z.ZodType<Prisma.TelemetryEventSelect> = z.object({
...
export const TelemetryEventFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    sessionId: z.boolean().optional(),
...
export const TelemetryEventFindFirstSchema: z.ZodType<Prisma.TelemetryEventFindFirstArgs> = z.object({ select: TelemetryEventFindFirstSelectSchema.optional(), include: z.lazy(() => TelemetryEventIncludeObjectSchema.optional()), orderBy: z.union([TelemetryEventOrderByWithRelationInputObjectSchema, TelemetryEventOrderByWithRelationInputObjectSchema.array()]).optional(), where: TelemetryEventWhereInputObjectSchema.optional(), cursor: TelemetryEventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TelemetryEventScalarFieldEnumSchema, TelemetryEventScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TelemetryEventFindFirstArgs>;

export const TelemetryEventFindFirstZodSchema = z.object({ select: TelemetryEventFindFirstSelectSchema.optional(), include: z.lazy(() => TelemetryEventIncludeObjectSchema.optional()), orderBy: z.union([TelemetryEventOrderByWithRelationInputObjectSchema, TelemetryEventOrderByWithRelationInputObjectSchema.array()]).optional(), where: TelemetryEventWhereInputObjectSchema.optional(), cursor: TelemetryEventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TelemetryEventScalarFieldEnumSchema, TelemetryEventScalarFieldEnumSchema.array()]).optional() }).strict();