...
export const PersonaAttributeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PersonaAttributeSelect> = z.object({
...
export const PersonaAttributeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    personaId: z.boolean().optional(),
...
export const PersonaAttributeFindFirstOrThrowSchema: z.ZodType<Prisma.PersonaAttributeFindFirstOrThrowArgs> = z.object({ select: PersonaAttributeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PersonaAttributeIncludeObjectSchema.optional()), orderBy: z.union([PersonaAttributeOrderByWithRelationInputObjectSchema, PersonaAttributeOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaAttributeWhereInputObjectSchema.optional(), cursor: PersonaAttributeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaAttributeScalarFieldEnumSchema, PersonaAttributeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PersonaAttributeFindFirstOrThrowArgs>;

export const PersonaAttributeFindFirstOrThrowZodSchema = z.object({ select: PersonaAttributeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PersonaAttributeIncludeObjectSchema.optional()), orderBy: z.union([PersonaAttributeOrderByWithRelationInputObjectSchema, PersonaAttributeOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaAttributeWhereInputObjectSchema.optional(), cursor: PersonaAttributeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaAttributeScalarFieldEnumSchema, PersonaAttributeScalarFieldEnumSchema.array()]).optional() }).strict();