...
export const WikidataCacheEntryFindManySelectSchema: z.ZodType<Prisma.WikidataCacheEntrySelect> = z.object({
...
export const WikidataCacheEntryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    resource: z.boolean().optional(),
    endpoint: z.boolean().optional(),
    params: z.boolean().optional(),
...
export const WikidataCacheEntryFindManySchema: z.ZodType<Prisma.WikidataCacheEntryFindManyArgs> = z.object({ select: WikidataCacheEntryFindManySelectSchema.optional(),  orderBy: z.union([WikidataCacheEntryOrderByWithRelationInputObjectSchema, WikidataCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WikidataCacheEntryWhereInputObjectSchema.optional(), cursor: WikidataCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WikidataCacheEntryScalarFieldEnumSchema, WikidataCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WikidataCacheEntryFindManyArgs>;

export const WikidataCacheEntryFindManyZodSchema = z.object({ select: WikidataCacheEntryFindManySelectSchema.optional(),  orderBy: z.union([WikidataCacheEntryOrderByWithRelationInputObjectSchema, WikidataCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WikidataCacheEntryWhereInputObjectSchema.optional(), cursor: WikidataCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WikidataCacheEntryScalarFieldEnumSchema, WikidataCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();