...
export const AgricultureInventoryMovementFindManySelectSchema: z.ZodType<Prisma.AgricultureInventoryMovementSelect> = z.object({
...
export const AgricultureInventoryMovementFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    inventoryId: z.boolean().optional(),
...
export const AgricultureInventoryMovementFindManySchema: z.ZodType<Prisma.AgricultureInventoryMovementFindManyArgs> = z.object({ select: AgricultureInventoryMovementFindManySelectSchema.optional(), include: z.lazy(() => AgricultureInventoryMovementIncludeObjectSchema.optional()), orderBy: z.union([AgricultureInventoryMovementOrderByWithRelationInputObjectSchema, AgricultureInventoryMovementOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureInventoryMovementWhereInputObjectSchema.optional(), cursor: AgricultureInventoryMovementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureInventoryMovementScalarFieldEnumSchema, AgricultureInventoryMovementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgricultureInventoryMovementFindManyArgs>;

export const AgricultureInventoryMovementFindManyZodSchema = z.object({ select: AgricultureInventoryMovementFindManySelectSchema.optional(), include: z.lazy(() => AgricultureInventoryMovementIncludeObjectSchema.optional()), orderBy: z.union([AgricultureInventoryMovementOrderByWithRelationInputObjectSchema, AgricultureInventoryMovementOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureInventoryMovementWhereInputObjectSchema.optional(), cursor: AgricultureInventoryMovementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureInventoryMovementScalarFieldEnumSchema, AgricultureInventoryMovementScalarFieldEnumSchema.array()]).optional() }).strict();