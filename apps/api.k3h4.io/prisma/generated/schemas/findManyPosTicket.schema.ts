...
export const PosTicketFindManySelectSchema: z.ZodType<Prisma.PosTicketSelect> = z.object({
...
export const PosTicketFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    storeId: z.boolean().optional(),
...
export const PosTicketFindManySchema: z.ZodType<Prisma.PosTicketFindManyArgs> = z.object({ select: PosTicketFindManySelectSchema.optional(), include: z.lazy(() => PosTicketIncludeObjectSchema.optional()), orderBy: z.union([PosTicketOrderByWithRelationInputObjectSchema, PosTicketOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosTicketWhereInputObjectSchema.optional(), cursor: PosTicketWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosTicketScalarFieldEnumSchema, PosTicketScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PosTicketFindManyArgs>;

export const PosTicketFindManyZodSchema = z.object({ select: PosTicketFindManySelectSchema.optional(), include: z.lazy(() => PosTicketIncludeObjectSchema.optional()), orderBy: z.union([PosTicketOrderByWithRelationInputObjectSchema, PosTicketOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosTicketWhereInputObjectSchema.optional(), cursor: PosTicketWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosTicketScalarFieldEnumSchema, PosTicketScalarFieldEnumSchema.array()]).optional() }).strict();