...
export const ProviderGrantFindManySelectSchema: z.ZodType<Prisma.ProviderGrantSelect> = z.object({
...
export const ProviderGrantFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    provider: z.boolean().optional(),
...
export const ProviderGrantFindManySchema: z.ZodType<Prisma.ProviderGrantFindManyArgs> = z.object({ select: ProviderGrantFindManySelectSchema.optional(), include: z.lazy(() => ProviderGrantIncludeObjectSchema.optional()), orderBy: z.union([ProviderGrantOrderByWithRelationInputObjectSchema, ProviderGrantOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProviderGrantWhereInputObjectSchema.optional(), cursor: ProviderGrantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProviderGrantScalarFieldEnumSchema, ProviderGrantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProviderGrantFindManyArgs>;

export const ProviderGrantFindManyZodSchema = z.object({ select: ProviderGrantFindManySelectSchema.optional(), include: z.lazy(() => ProviderGrantIncludeObjectSchema.optional()), orderBy: z.union([ProviderGrantOrderByWithRelationInputObjectSchema, ProviderGrantOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProviderGrantWhereInputObjectSchema.optional(), cursor: ProviderGrantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProviderGrantScalarFieldEnumSchema, ProviderGrantScalarFieldEnumSchema.array()]).optional() }).strict();