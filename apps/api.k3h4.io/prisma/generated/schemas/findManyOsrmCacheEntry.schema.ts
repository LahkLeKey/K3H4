...
export const OsrmCacheEntryFindManySelectSchema: z.ZodType<Prisma.OsrmCacheEntrySelect> = z.object({
...
export const OsrmCacheEntryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    service: z.boolean().optional(),
...
export const OsrmCacheEntryFindManySchema: z.ZodType<Prisma.OsrmCacheEntryFindManyArgs> = z.object({ select: OsrmCacheEntryFindManySelectSchema.optional(), include: z.lazy(() => OsrmCacheEntryIncludeObjectSchema.optional()), orderBy: z.union([OsrmCacheEntryOrderByWithRelationInputObjectSchema, OsrmCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: OsrmCacheEntryWhereInputObjectSchema.optional(), cursor: OsrmCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OsrmCacheEntryScalarFieldEnumSchema, OsrmCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OsrmCacheEntryFindManyArgs>;

export const OsrmCacheEntryFindManyZodSchema = z.object({ select: OsrmCacheEntryFindManySelectSchema.optional(), include: z.lazy(() => OsrmCacheEntryIncludeObjectSchema.optional()), orderBy: z.union([OsrmCacheEntryOrderByWithRelationInputObjectSchema, OsrmCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: OsrmCacheEntryWhereInputObjectSchema.optional(), cursor: OsrmCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OsrmCacheEntryScalarFieldEnumSchema, OsrmCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();