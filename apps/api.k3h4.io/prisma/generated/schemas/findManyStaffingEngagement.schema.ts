...
export const StaffingEngagementFindManySelectSchema: z.ZodType<Prisma.StaffingEngagementSelect> = z.object({
...
export const StaffingEngagementFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const StaffingEngagementFindManySchema: z.ZodType<Prisma.StaffingEngagementFindManyArgs> = z.object({ select: StaffingEngagementFindManySelectSchema.optional(), include: z.lazy(() => StaffingEngagementIncludeObjectSchema.optional()), orderBy: z.union([StaffingEngagementOrderByWithRelationInputObjectSchema, StaffingEngagementOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingEngagementWhereInputObjectSchema.optional(), cursor: StaffingEngagementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingEngagementScalarFieldEnumSchema, StaffingEngagementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffingEngagementFindManyArgs>;

export const StaffingEngagementFindManyZodSchema = z.object({ select: StaffingEngagementFindManySelectSchema.optional(), include: z.lazy(() => StaffingEngagementIncludeObjectSchema.optional()), orderBy: z.union([StaffingEngagementOrderByWithRelationInputObjectSchema, StaffingEngagementOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingEngagementWhereInputObjectSchema.optional(), cursor: StaffingEngagementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingEngagementScalarFieldEnumSchema, StaffingEngagementScalarFieldEnumSchema.array()]).optional() }).strict();