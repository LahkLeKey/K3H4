...
export const AgricultureResourceFindManySelectSchema: z.ZodType<Prisma.AgricultureResourceSelect> = z.object({
...
export const AgricultureResourceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    categoryId: z.boolean().optional(),
    category: z.boolean().optional(),
    title: z.boolean().optional(),
...
export const AgricultureResourceFindManySchema: z.ZodType<Prisma.AgricultureResourceFindManyArgs> = z.object({ select: AgricultureResourceFindManySelectSchema.optional(), include: z.lazy(() => AgricultureResourceIncludeObjectSchema.optional()), orderBy: z.union([AgricultureResourceOrderByWithRelationInputObjectSchema, AgricultureResourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureResourceWhereInputObjectSchema.optional(), cursor: AgricultureResourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureResourceScalarFieldEnumSchema, AgricultureResourceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgricultureResourceFindManyArgs>;

export const AgricultureResourceFindManyZodSchema = z.object({ select: AgricultureResourceFindManySelectSchema.optional(), include: z.lazy(() => AgricultureResourceIncludeObjectSchema.optional()), orderBy: z.union([AgricultureResourceOrderByWithRelationInputObjectSchema, AgricultureResourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureResourceWhereInputObjectSchema.optional(), cursor: AgricultureResourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureResourceScalarFieldEnumSchema, AgricultureResourceScalarFieldEnumSchema.array()]).optional() }).strict();