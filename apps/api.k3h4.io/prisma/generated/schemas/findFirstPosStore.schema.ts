...
export const PosStoreFindFirstSelectSchema: z.ZodType<Prisma.PosStoreSelect> = z.object({
...
export const PosStoreFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
