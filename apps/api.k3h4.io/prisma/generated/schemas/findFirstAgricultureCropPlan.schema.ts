...
export const AgricultureCropPlanFindFirstSelectSchema: z.ZodType<Prisma.AgricultureCropPlanSelect> = z.object({
...
export const AgricultureCropPlanFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    plotId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const AgricultureCropPlanFindFirstSchema: z.ZodType<Prisma.AgricultureCropPlanFindFirstArgs> = z.object({ select: AgricultureCropPlanFindFirstSelectSchema.optional(), include: z.lazy(() => AgricultureCropPlanIncludeObjectSchema.optional()), orderBy: z.union([AgricultureCropPlanOrderByWithRelationInputObjectSchema, AgricultureCropPlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureCropPlanWhereInputObjectSchema.optional(), cursor: AgricultureCropPlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureCropPlanScalarFieldEnumSchema, AgricultureCropPlanScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgricultureCropPlanFindFirstArgs>;

export const AgricultureCropPlanFindFirstZodSchema = z.object({ select: AgricultureCropPlanFindFirstSelectSchema.optional(), include: z.lazy(() => AgricultureCropPlanIncludeObjectSchema.optional()), orderBy: z.union([AgricultureCropPlanOrderByWithRelationInputObjectSchema, AgricultureCropPlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureCropPlanWhereInputObjectSchema.optional(), cursor: AgricultureCropPlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureCropPlanScalarFieldEnumSchema, AgricultureCropPlanScalarFieldEnumSchema.array()]).optional() }).strict();