...
export const RefreshTokenUpdateOneSchema: z.ZodType<Prisma.RefreshTokenUpdateArgs> = z.object({ select: RefreshTokenSelectObjectSchema.optional(), include: RefreshTokenIncludeObjectSchema.optional(), data: z.union([RefreshTokenUpdateInputObjectSchema, RefreshTokenUncheckedUpdateInputObjectSchema]), where: RefreshTokenWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.RefreshTokenUpdateArgs>;

export const RefreshTokenUpdateOneZodSchema = z.object({ select: RefreshTokenSelectObjectSchema.optional(), include: RefreshTokenIncludeObjectSchema.optional(), data: z.union([RefreshTokenUpdateInputObjectSchema, RefreshTokenUncheckedUpdateInputObjectSchema]), where: RefreshTokenWhereUniqueInputObjectSchema }).strict();