...
export const GeoQueryCacheFindFirstSelectSchema: z.ZodType<Prisma.GeoQueryCacheSelect> = z.object({
...
export const GeoQueryCacheFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const GeoQueryCacheFindFirstSchema: z.ZodType<Prisma.GeoQueryCacheFindFirstArgs> = z.object({ select: GeoQueryCacheFindFirstSelectSchema.optional(), include: z.lazy(() => GeoQueryCacheIncludeObjectSchema.optional()), orderBy: z.union([GeoQueryCacheOrderByWithRelationInputObjectSchema, GeoQueryCacheOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoQueryCacheWhereInputObjectSchema.optional(), cursor: GeoQueryCacheWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoQueryCacheScalarFieldEnumSchema, GeoQueryCacheScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoQueryCacheFindFirstArgs>;

export const GeoQueryCacheFindFirstZodSchema = z.object({ select: GeoQueryCacheFindFirstSelectSchema.optional(), include: z.lazy(() => GeoQueryCacheIncludeObjectSchema.optional()), orderBy: z.union([GeoQueryCacheOrderByWithRelationInputObjectSchema, GeoQueryCacheOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoQueryCacheWhereInputObjectSchema.optional(), cursor: GeoQueryCacheWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoQueryCacheScalarFieldEnumSchema, GeoQueryCacheScalarFieldEnumSchema.array()]).optional() }).strict();