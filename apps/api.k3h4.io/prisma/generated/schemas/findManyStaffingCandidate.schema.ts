...
export const StaffingCandidateFindManySelectSchema: z.ZodType<Prisma.StaffingCandidateSelect> = z.object({
...
export const StaffingCandidateFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    engagementId: z.boolean().optional(),
...
export const StaffingCandidateFindManySchema: z.ZodType<Prisma.StaffingCandidateFindManyArgs> = z.object({ select: StaffingCandidateFindManySelectSchema.optional(), include: z.lazy(() => StaffingCandidateIncludeObjectSchema.optional()), orderBy: z.union([StaffingCandidateOrderByWithRelationInputObjectSchema, StaffingCandidateOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingCandidateWhereInputObjectSchema.optional(), cursor: StaffingCandidateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingCandidateScalarFieldEnumSchema, StaffingCandidateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffingCandidateFindManyArgs>;

export const StaffingCandidateFindManyZodSchema = z.object({ select: StaffingCandidateFindManySelectSchema.optional(), include: z.lazy(() => StaffingCandidateIncludeObjectSchema.optional()), orderBy: z.union([StaffingCandidateOrderByWithRelationInputObjectSchema, StaffingCandidateOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingCandidateWhereInputObjectSchema.optional(), cursor: StaffingCandidateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingCandidateScalarFieldEnumSchema, StaffingCandidateScalarFieldEnumSchema.array()]).optional() }).strict();