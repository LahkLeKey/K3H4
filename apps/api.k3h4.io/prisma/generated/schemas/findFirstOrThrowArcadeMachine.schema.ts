...
export const ArcadeMachineFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArcadeMachineSelect> = z.object({
...
export const ArcadeMachineFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const ArcadeMachineFindFirstOrThrowSchema: z.ZodType<Prisma.ArcadeMachineFindFirstOrThrowArgs> = z.object({ select: ArcadeMachineFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeMachineIncludeObjectSchema.optional()), orderBy: z.union([ArcadeMachineOrderByWithRelationInputObjectSchema, ArcadeMachineOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeMachineWhereInputObjectSchema.optional(), cursor: ArcadeMachineWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeMachineScalarFieldEnumSchema, ArcadeMachineScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeMachineFindFirstOrThrowArgs>;

export const ArcadeMachineFindFirstOrThrowZodSchema = z.object({ select: ArcadeMachineFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeMachineIncludeObjectSchema.optional()), orderBy: z.union([ArcadeMachineOrderByWithRelationInputObjectSchema, ArcadeMachineOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeMachineWhereInputObjectSchema.optional(), cursor: ArcadeMachineWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeMachineScalarFieldEnumSchema, ArcadeMachineScalarFieldEnumSchema.array()]).optional() }).strict();