...
export const AgriculturePlotFindManySelectSchema: z.ZodType<Prisma.AgriculturePlotSelect> = z.object({
...
export const AgriculturePlotFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const AgriculturePlotFindManySchema: z.ZodType<Prisma.AgriculturePlotFindManyArgs> = z.object({ select: AgriculturePlotFindManySelectSchema.optional(), include: z.lazy(() => AgriculturePlotIncludeObjectSchema.optional()), orderBy: z.union([AgriculturePlotOrderByWithRelationInputObjectSchema, AgriculturePlotOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgriculturePlotWhereInputObjectSchema.optional(), cursor: AgriculturePlotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgriculturePlotScalarFieldEnumSchema, AgriculturePlotScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgriculturePlotFindManyArgs>;

export const AgriculturePlotFindManyZodSchema = z.object({ select: AgriculturePlotFindManySelectSchema.optional(), include: z.lazy(() => AgriculturePlotIncludeObjectSchema.optional()), orderBy: z.union([AgriculturePlotOrderByWithRelationInputObjectSchema, AgriculturePlotOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgriculturePlotWhereInputObjectSchema.optional(), cursor: AgriculturePlotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgriculturePlotScalarFieldEnumSchema, AgriculturePlotScalarFieldEnumSchema.array()]).optional() }).strict();