...
export const StaffingPlacementFindFirstSelectSchema: z.ZodType<Prisma.StaffingPlacementSelect> = z.object({
...
export const StaffingPlacementFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    engagementId: z.boolean().optional(),
