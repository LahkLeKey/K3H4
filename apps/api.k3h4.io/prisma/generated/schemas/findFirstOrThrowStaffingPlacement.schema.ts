...
export const StaffingPlacementFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StaffingPlacementSelect> = z.object({
...
export const StaffingPlacementFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    engagementId: z.boolean().optional(),
...
export const StaffingPlacementFindFirstOrThrowSchema: z.ZodType<Prisma.StaffingPlacementFindFirstOrThrowArgs> = z.object({ select: StaffingPlacementFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StaffingPlacementIncludeObjectSchema.optional()), orderBy: z.union([StaffingPlacementOrderByWithRelationInputObjectSchema, StaffingPlacementOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingPlacementWhereInputObjectSchema.optional(), cursor: StaffingPlacementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingPlacementScalarFieldEnumSchema, StaffingPlacementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffingPlacementFindFirstOrThrowArgs>;

export const StaffingPlacementFindFirstOrThrowZodSchema = z.object({ select: StaffingPlacementFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StaffingPlacementIncludeObjectSchema.optional()), orderBy: z.union([StaffingPlacementOrderByWithRelationInputObjectSchema, StaffingPlacementOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingPlacementWhereInputObjectSchema.optional(), cursor: StaffingPlacementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingPlacementScalarFieldEnumSchema, StaffingPlacementScalarFieldEnumSchema.array()]).optional() }).strict();