...
export const ProviderGrantFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProviderGrantSelect> = z.object({
...
export const ProviderGrantFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    provider: z.boolean().optional(),
...
export const ProviderGrantFindFirstOrThrowSchema: z.ZodType<Prisma.ProviderGrantFindFirstOrThrowArgs> = z.object({ select: ProviderGrantFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProviderGrantIncludeObjectSchema.optional()), orderBy: z.union([ProviderGrantOrderByWithRelationInputObjectSchema, ProviderGrantOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProviderGrantWhereInputObjectSchema.optional(), cursor: ProviderGrantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProviderGrantScalarFieldEnumSchema, ProviderGrantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProviderGrantFindFirstOrThrowArgs>;

export const ProviderGrantFindFirstOrThrowZodSchema = z.object({ select: ProviderGrantFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProviderGrantIncludeObjectSchema.optional()), orderBy: z.union([ProviderGrantOrderByWithRelationInputObjectSchema, ProviderGrantOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProviderGrantWhereInputObjectSchema.optional(), cursor: ProviderGrantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProviderGrantScalarFieldEnumSchema, ProviderGrantScalarFieldEnumSchema.array()]).optional() }).strict();