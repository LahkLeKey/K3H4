...
export const GeoDirectionStopFindManySelectSchema: z.ZodType<Prisma.GeoDirectionStopSelect> = z.object({
...
export const GeoDirectionStopFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    directionId: z.boolean().optional(),
    direction: z.boolean().optional(),
    sequence: z.boolean().optional(),
...
export const GeoDirectionStopFindManySchema: z.ZodType<Prisma.GeoDirectionStopFindManyArgs> = z.object({ select: GeoDirectionStopFindManySelectSchema.optional(), include: z.lazy(() => GeoDirectionStopIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionStopOrderByWithRelationInputObjectSchema, GeoDirectionStopOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionStopWhereInputObjectSchema.optional(), cursor: GeoDirectionStopWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionStopScalarFieldEnumSchema, GeoDirectionStopScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoDirectionStopFindManyArgs>;

export const GeoDirectionStopFindManyZodSchema = z.object({ select: GeoDirectionStopFindManySelectSchema.optional(), include: z.lazy(() => GeoDirectionStopIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionStopOrderByWithRelationInputObjectSchema, GeoDirectionStopOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionStopWhereInputObjectSchema.optional(), cursor: GeoDirectionStopWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionStopScalarFieldEnumSchema, GeoDirectionStopScalarFieldEnumSchema.array()]).optional() }).strict();