...
export const ArcadeTopUpFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArcadeTopUpSelect> = z.object({
...
export const ArcadeTopUpFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    cardId: z.boolean().optional(),
...
export const ArcadeTopUpFindFirstOrThrowSchema: z.ZodType<Prisma.ArcadeTopUpFindFirstOrThrowArgs> = z.object({ select: ArcadeTopUpFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeTopUpIncludeObjectSchema.optional()), orderBy: z.union([ArcadeTopUpOrderByWithRelationInputObjectSchema, ArcadeTopUpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeTopUpWhereInputObjectSchema.optional(), cursor: ArcadeTopUpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeTopUpScalarFieldEnumSchema, ArcadeTopUpScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeTopUpFindFirstOrThrowArgs>;

export const ArcadeTopUpFindFirstOrThrowZodSchema = z.object({ select: ArcadeTopUpFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeTopUpIncludeObjectSchema.optional()), orderBy: z.union([ArcadeTopUpOrderByWithRelationInputObjectSchema, ArcadeTopUpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeTopUpWhereInputObjectSchema.optional(), cursor: ArcadeTopUpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeTopUpScalarFieldEnumSchema, ArcadeTopUpScalarFieldEnumSchema.array()]).optional() }).strict();