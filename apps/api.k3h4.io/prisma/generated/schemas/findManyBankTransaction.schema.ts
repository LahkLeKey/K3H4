...
export const BankTransactionFindManySelectSchema: z.ZodType<Prisma.BankTransactionSelect> = z.object({
...
export const BankTransactionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    amount: z.boolean().optional(),
...
export const BankTransactionFindManySchema: z.ZodType<Prisma.BankTransactionFindManyArgs> = z.object({ select: BankTransactionFindManySelectSchema.optional(), include: z.lazy(() => BankTransactionIncludeObjectSchema.optional()), orderBy: z.union([BankTransactionOrderByWithRelationInputObjectSchema, BankTransactionOrderByWithRelationInputObjectSchema.array()]).optional(), where: BankTransactionWhereInputObjectSchema.optional(), cursor: BankTransactionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BankTransactionScalarFieldEnumSchema, BankTransactionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BankTransactionFindManyArgs>;

export const BankTransactionFindManyZodSchema = z.object({ select: BankTransactionFindManySelectSchema.optional(), include: z.lazy(() => BankTransactionIncludeObjectSchema.optional()), orderBy: z.union([BankTransactionOrderByWithRelationInputObjectSchema, BankTransactionOrderByWithRelationInputObjectSchema.array()]).optional(), where: BankTransactionWhereInputObjectSchema.optional(), cursor: BankTransactionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BankTransactionScalarFieldEnumSchema, BankTransactionScalarFieldEnumSchema.array()]).optional() }).strict();