...
export const GeoDirectionStopFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GeoDirectionStopSelect> = z.object({
...
export const GeoDirectionStopFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    directionId: z.boolean().optional(),
    direction: z.boolean().optional(),
    sequence: z.boolean().optional(),
...
export const GeoDirectionStopFindFirstOrThrowSchema: z.ZodType<Prisma.GeoDirectionStopFindFirstOrThrowArgs> = z.object({ select: GeoDirectionStopFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GeoDirectionStopIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionStopOrderByWithRelationInputObjectSchema, GeoDirectionStopOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionStopWhereInputObjectSchema.optional(), cursor: GeoDirectionStopWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionStopScalarFieldEnumSchema, GeoDirectionStopScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoDirectionStopFindFirstOrThrowArgs>;

export const GeoDirectionStopFindFirstOrThrowZodSchema = z.object({ select: GeoDirectionStopFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GeoDirectionStopIncludeObjectSchema.optional()), orderBy: z.union([GeoDirectionStopOrderByWithRelationInputObjectSchema, GeoDirectionStopOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDirectionStopWhereInputObjectSchema.optional(), cursor: GeoDirectionStopWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDirectionStopScalarFieldEnumSchema, GeoDirectionStopScalarFieldEnumSchema.array()]).optional() }).strict();