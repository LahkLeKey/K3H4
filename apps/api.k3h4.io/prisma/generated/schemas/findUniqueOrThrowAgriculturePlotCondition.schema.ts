...
export const AgriculturePlotConditionFindUniqueOrThrowSchema: z.ZodType<Prisma.AgriculturePlotConditionFindUniqueOrThrowArgs> = z.object({ select: AgriculturePlotConditionSelectObjectSchema.optional(), include: AgriculturePlotConditionIncludeObjectSchema.optional(), where: AgriculturePlotConditionWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.AgriculturePlotConditionFindUniqueOrThrowArgs>;

export const AgriculturePlotConditionFindUniqueOrThrowZodSchema = z.object({ select: AgriculturePlotConditionSelectObjectSchema.optional(), include: AgriculturePlotConditionIncludeObjectSchema.optional(), where: AgriculturePlotConditionWhereUniqueInputObjectSchema }).strict();