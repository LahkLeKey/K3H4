...
export const PersonaFindManySelectSchema: z.ZodType<Prisma.PersonaSelect> = z.object({
...
export const PersonaFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    alias: z.boolean().optional(),
...
export const PersonaFindManySchema: z.ZodType<Prisma.PersonaFindManyArgs> = z.object({ select: PersonaFindManySelectSchema.optional(), include: z.lazy(() => PersonaIncludeObjectSchema.optional()), orderBy: z.union([PersonaOrderByWithRelationInputObjectSchema, PersonaOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaWhereInputObjectSchema.optional(), cursor: PersonaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaScalarFieldEnumSchema, PersonaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PersonaFindManyArgs>;

export const PersonaFindManyZodSchema = z.object({ select: PersonaFindManySelectSchema.optional(), include: z.lazy(() => PersonaIncludeObjectSchema.optional()), orderBy: z.union([PersonaOrderByWithRelationInputObjectSchema, PersonaOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaWhereInputObjectSchema.optional(), cursor: PersonaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaScalarFieldEnumSchema, PersonaScalarFieldEnumSchema.array()]).optional() }).strict();