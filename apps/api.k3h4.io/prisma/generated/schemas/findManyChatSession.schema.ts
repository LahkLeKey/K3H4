...
export const ChatSessionFindManySelectSchema: z.ZodType<Prisma.ChatSessionSelect> = z.object({
...
export const ChatSessionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    title: z.boolean().optional(),
