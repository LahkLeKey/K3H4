...
export const UsdaCacheEntryFindManySelectSchema: z.ZodType<Prisma.UsdaCacheEntrySelect> = z.object({
...
export const UsdaCacheEntryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    endpoint: z.boolean().optional(),
    params: z.boolean().optional(),
...
export const UsdaCacheEntryFindManySchema: z.ZodType<Prisma.UsdaCacheEntryFindManyArgs> = z.object({ select: UsdaCacheEntryFindManySelectSchema.optional(),  orderBy: z.union([UsdaCacheEntryOrderByWithRelationInputObjectSchema, UsdaCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCacheEntryWhereInputObjectSchema.optional(), cursor: UsdaCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCacheEntryScalarFieldEnumSchema, UsdaCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaCacheEntryFindManyArgs>;

export const UsdaCacheEntryFindManyZodSchema = z.object({ select: UsdaCacheEntryFindManySelectSchema.optional(),  orderBy: z.union([UsdaCacheEntryOrderByWithRelationInputObjectSchema, UsdaCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCacheEntryWhereInputObjectSchema.optional(), cursor: UsdaCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCacheEntryScalarFieldEnumSchema, UsdaCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();