...
export const AssignmentTimecardFindManySelectSchema: z.ZodType<Prisma.AssignmentTimecardSelect> = z.object({
...
export const AssignmentTimecardFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    assignmentId: z.boolean().optional(),
    assignment: z.boolean().optional(),
    hours: z.boolean().optional(),
...
export const AssignmentTimecardFindManySchema: z.ZodType<Prisma.AssignmentTimecardFindManyArgs> = z.object({ select: AssignmentTimecardFindManySelectSchema.optional(), include: z.lazy(() => AssignmentTimecardIncludeObjectSchema.optional()), orderBy: z.union([AssignmentTimecardOrderByWithRelationInputObjectSchema, AssignmentTimecardOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssignmentTimecardWhereInputObjectSchema.optional(), cursor: AssignmentTimecardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssignmentTimecardScalarFieldEnumSchema, AssignmentTimecardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AssignmentTimecardFindManyArgs>;

export const AssignmentTimecardFindManyZodSchema = z.object({ select: AssignmentTimecardFindManySelectSchema.optional(), include: z.lazy(() => AssignmentTimecardIncludeObjectSchema.optional()), orderBy: z.union([AssignmentTimecardOrderByWithRelationInputObjectSchema, AssignmentTimecardOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssignmentTimecardWhereInputObjectSchema.optional(), cursor: AssignmentTimecardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssignmentTimecardScalarFieldEnumSchema, AssignmentTimecardScalarFieldEnumSchema.array()]).optional() }).strict();