...
export const ArcadeCardFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArcadeCardSelect> = z.object({
...
export const ArcadeCardFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const ArcadeCardFindFirstOrThrowSchema: z.ZodType<Prisma.ArcadeCardFindFirstOrThrowArgs> = z.object({ select: ArcadeCardFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeCardIncludeObjectSchema.optional()), orderBy: z.union([ArcadeCardOrderByWithRelationInputObjectSchema, ArcadeCardOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeCardWhereInputObjectSchema.optional(), cursor: ArcadeCardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeCardScalarFieldEnumSchema, ArcadeCardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeCardFindFirstOrThrowArgs>;

export const ArcadeCardFindFirstOrThrowZodSchema = z.object({ select: ArcadeCardFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeCardIncludeObjectSchema.optional()), orderBy: z.union([ArcadeCardOrderByWithRelationInputObjectSchema, ArcadeCardOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeCardWhereInputObjectSchema.optional(), cursor: ArcadeCardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeCardScalarFieldEnumSchema, ArcadeCardScalarFieldEnumSchema.array()]).optional() }).strict();