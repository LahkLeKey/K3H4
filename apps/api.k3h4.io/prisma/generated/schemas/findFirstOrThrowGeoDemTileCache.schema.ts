...
export const GeoDemTileCacheFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GeoDemTileCacheSelect> = z.object({
...
export const GeoDemTileCacheFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    provider: z.boolean().optional(),
...
export const GeoDemTileCacheFindFirstOrThrowSchema: z.ZodType<Prisma.GeoDemTileCacheFindFirstOrThrowArgs> = z.object({ select: GeoDemTileCacheFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GeoDemTileCacheIncludeObjectSchema.optional()), orderBy: z.union([GeoDemTileCacheOrderByWithRelationInputObjectSchema, GeoDemTileCacheOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDemTileCacheWhereInputObjectSchema.optional(), cursor: GeoDemTileCacheWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDemTileCacheScalarFieldEnumSchema, GeoDemTileCacheScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoDemTileCacheFindFirstOrThrowArgs>;

export const GeoDemTileCacheFindFirstOrThrowZodSchema = z.object({ select: GeoDemTileCacheFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GeoDemTileCacheIncludeObjectSchema.optional()), orderBy: z.union([GeoDemTileCacheOrderByWithRelationInputObjectSchema, GeoDemTileCacheOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoDemTileCacheWhereInputObjectSchema.optional(), cursor: GeoDemTileCacheWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoDemTileCacheScalarFieldEnumSchema, GeoDemTileCacheScalarFieldEnumSchema.array()]).optional() }).strict();