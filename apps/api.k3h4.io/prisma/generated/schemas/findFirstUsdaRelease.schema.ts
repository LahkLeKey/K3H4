...
export const UsdaReleaseFindFirstSelectSchema: z.ZodType<Prisma.UsdaReleaseSelect> = z.object({
...
export const UsdaReleaseFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    scope: z.boolean().optional(),
    releasedOn: z.boolean().optional(),
...
export const UsdaReleaseFindFirstSchema: z.ZodType<Prisma.UsdaReleaseFindFirstArgs> = z.object({ select: UsdaReleaseFindFirstSelectSchema.optional(),  orderBy: z.union([UsdaReleaseOrderByWithRelationInputObjectSchema, UsdaReleaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaReleaseWhereInputObjectSchema.optional(), cursor: UsdaReleaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaReleaseScalarFieldEnumSchema, UsdaReleaseScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaReleaseFindFirstArgs>;

export const UsdaReleaseFindFirstZodSchema = z.object({ select: UsdaReleaseFindFirstSelectSchema.optional(),  orderBy: z.union([UsdaReleaseOrderByWithRelationInputObjectSchema, UsdaReleaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaReleaseWhereInputObjectSchema.optional(), cursor: UsdaReleaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaReleaseScalarFieldEnumSchema, UsdaReleaseScalarFieldEnumSchema.array()]).optional() }).strict();