...
export const AgriculturePlotConditionFindFirstSelectSchema: z.ZodType<Prisma.AgriculturePlotConditionSelect> = z.object({
...
export const AgriculturePlotConditionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    plotId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const AgriculturePlotConditionFindFirstSchema: z.ZodType<Prisma.AgriculturePlotConditionFindFirstArgs> = z.object({ select: AgriculturePlotConditionFindFirstSelectSchema.optional(), include: z.lazy(() => AgriculturePlotConditionIncludeObjectSchema.optional()), orderBy: z.union([AgriculturePlotConditionOrderByWithRelationInputObjectSchema, AgriculturePlotConditionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgriculturePlotConditionWhereInputObjectSchema.optional(), cursor: AgriculturePlotConditionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgriculturePlotConditionScalarFieldEnumSchema, AgriculturePlotConditionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgriculturePlotConditionFindFirstArgs>;

export const AgriculturePlotConditionFindFirstZodSchema = z.object({ select: AgriculturePlotConditionFindFirstSelectSchema.optional(), include: z.lazy(() => AgriculturePlotConditionIncludeObjectSchema.optional()), orderBy: z.union([AgriculturePlotConditionOrderByWithRelationInputObjectSchema, AgriculturePlotConditionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgriculturePlotConditionWhereInputObjectSchema.optional(), cursor: AgriculturePlotConditionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgriculturePlotConditionScalarFieldEnumSchema, AgriculturePlotConditionScalarFieldEnumSchema.array()]).optional() }).strict();