...
export const ArcadeTopUpFindManySelectSchema: z.ZodType<Prisma.ArcadeTopUpSelect> = z.object({
...
export const ArcadeTopUpFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    cardId: z.boolean().optional(),
...
export const ArcadeTopUpFindManySchema: z.ZodType<Prisma.ArcadeTopUpFindManyArgs> = z.object({ select: ArcadeTopUpFindManySelectSchema.optional(), include: z.lazy(() => ArcadeTopUpIncludeObjectSchema.optional()), orderBy: z.union([ArcadeTopUpOrderByWithRelationInputObjectSchema, ArcadeTopUpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeTopUpWhereInputObjectSchema.optional(), cursor: ArcadeTopUpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeTopUpScalarFieldEnumSchema, ArcadeTopUpScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeTopUpFindManyArgs>;

export const ArcadeTopUpFindManyZodSchema = z.object({ select: ArcadeTopUpFindManySelectSchema.optional(), include: z.lazy(() => ArcadeTopUpIncludeObjectSchema.optional()), orderBy: z.union([ArcadeTopUpOrderByWithRelationInputObjectSchema, ArcadeTopUpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeTopUpWhereInputObjectSchema.optional(), cursor: ArcadeTopUpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeTopUpScalarFieldEnumSchema, ArcadeTopUpScalarFieldEnumSchema.array()]).optional() }).strict();