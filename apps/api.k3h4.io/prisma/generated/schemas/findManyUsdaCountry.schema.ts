...
export const UsdaCountryFindManySelectSchema: z.ZodType<Prisma.UsdaCountrySelect> = z.object({
...
export const UsdaCountryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const UsdaCountryFindManySchema: z.ZodType<Prisma.UsdaCountryFindManyArgs> = z.object({ select: UsdaCountryFindManySelectSchema.optional(),  orderBy: z.union([UsdaCountryOrderByWithRelationInputObjectSchema, UsdaCountryOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCountryWhereInputObjectSchema.optional(), cursor: UsdaCountryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCountryScalarFieldEnumSchema, UsdaCountryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaCountryFindManyArgs>;

export const UsdaCountryFindManyZodSchema = z.object({ select: UsdaCountryFindManySelectSchema.optional(),  orderBy: z.union([UsdaCountryOrderByWithRelationInputObjectSchema, UsdaCountryOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCountryWhereInputObjectSchema.optional(), cursor: UsdaCountryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCountryScalarFieldEnumSchema, UsdaCountryScalarFieldEnumSchema.array()]).optional() }).strict();