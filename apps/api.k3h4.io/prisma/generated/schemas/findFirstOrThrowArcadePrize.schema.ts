...
export const ArcadePrizeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArcadePrizeSelect> = z.object({
...
export const ArcadePrizeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const ArcadePrizeFindFirstOrThrowSchema: z.ZodType<Prisma.ArcadePrizeFindFirstOrThrowArgs> = z.object({ select: ArcadePrizeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadePrizeIncludeObjectSchema.optional()), orderBy: z.union([ArcadePrizeOrderByWithRelationInputObjectSchema, ArcadePrizeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadePrizeWhereInputObjectSchema.optional(), cursor: ArcadePrizeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadePrizeScalarFieldEnumSchema, ArcadePrizeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadePrizeFindFirstOrThrowArgs>;

export const ArcadePrizeFindFirstOrThrowZodSchema = z.object({ select: ArcadePrizeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadePrizeIncludeObjectSchema.optional()), orderBy: z.union([ArcadePrizeOrderByWithRelationInputObjectSchema, ArcadePrizeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadePrizeWhereInputObjectSchema.optional(), cursor: ArcadePrizeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadePrizeScalarFieldEnumSchema, ArcadePrizeScalarFieldEnumSchema.array()]).optional() }).strict();