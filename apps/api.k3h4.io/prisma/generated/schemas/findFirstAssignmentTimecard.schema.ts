...
export const AssignmentTimecardFindFirstSelectSchema: z.ZodType<Prisma.AssignmentTimecardSelect> = z.object({
...
export const AssignmentTimecardFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    assignmentId: z.boolean().optional(),
    assignment: z.boolean().optional(),
    hours: z.boolean().optional(),
...
export const AssignmentTimecardFindFirstSchema: z.ZodType<Prisma.AssignmentTimecardFindFirstArgs> = z.object({ select: AssignmentTimecardFindFirstSelectSchema.optional(), include: z.lazy(() => AssignmentTimecardIncludeObjectSchema.optional()), orderBy: z.union([AssignmentTimecardOrderByWithRelationInputObjectSchema, AssignmentTimecardOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssignmentTimecardWhereInputObjectSchema.optional(), cursor: AssignmentTimecardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssignmentTimecardScalarFieldEnumSchema, AssignmentTimecardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AssignmentTimecardFindFirstArgs>;

export const AssignmentTimecardFindFirstZodSchema = z.object({ select: AssignmentTimecardFindFirstSelectSchema.optional(), include: z.lazy(() => AssignmentTimecardIncludeObjectSchema.optional()), orderBy: z.union([AssignmentTimecardOrderByWithRelationInputObjectSchema, AssignmentTimecardOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssignmentTimecardWhereInputObjectSchema.optional(), cursor: AssignmentTimecardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssignmentTimecardScalarFieldEnumSchema, AssignmentTimecardScalarFieldEnumSchema.array()]).optional() }).strict();