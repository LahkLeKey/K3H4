...
export const CulinaryPrepTaskFindManySelectSchema: z.ZodType<Prisma.CulinaryPrepTaskSelect> = z.object({
...
export const CulinaryPrepTaskFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    task: z.boolean().optional(),
...
export const CulinaryPrepTaskFindManySchema: z.ZodType<Prisma.CulinaryPrepTaskFindManyArgs> = z.object({ select: CulinaryPrepTaskFindManySelectSchema.optional(), include: z.lazy(() => CulinaryPrepTaskIncludeObjectSchema.optional()), orderBy: z.union([CulinaryPrepTaskOrderByWithRelationInputObjectSchema, CulinaryPrepTaskOrderByWithRelationInputObjectSchema.array()]).optional(), where: CulinaryPrepTaskWhereInputObjectSchema.optional(), cursor: CulinaryPrepTaskWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CulinaryPrepTaskScalarFieldEnumSchema, CulinaryPrepTaskScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CulinaryPrepTaskFindManyArgs>;

export const CulinaryPrepTaskFindManyZodSchema = z.object({ select: CulinaryPrepTaskFindManySelectSchema.optional(), include: z.lazy(() => CulinaryPrepTaskIncludeObjectSchema.optional()), orderBy: z.union([CulinaryPrepTaskOrderByWithRelationInputObjectSchema, CulinaryPrepTaskOrderByWithRelationInputObjectSchema.array()]).optional(), where: CulinaryPrepTaskWhereInputObjectSchema.optional(), cursor: CulinaryPrepTaskWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CulinaryPrepTaskScalarFieldEnumSchema, CulinaryPrepTaskScalarFieldEnumSchema.array()]).optional() }).strict();