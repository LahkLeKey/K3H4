...
export const BuildingFindFirstSelectSchema: z.ZodType<Prisma.BuildingSelect> = z.object({
...
export const BuildingFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    osmId: z.boolean().optional(),
    type: z.boolean().optional(),
    addressHouseNumber: z.boolean().optional(),
