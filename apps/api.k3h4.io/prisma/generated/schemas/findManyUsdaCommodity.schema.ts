...
export const UsdaCommodityFindManySelectSchema: z.ZodType<Prisma.UsdaCommoditySelect> = z.object({
...
export const UsdaCommodityFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const UsdaCommodityFindManySchema: z.ZodType<Prisma.UsdaCommodityFindManyArgs> = z.object({ select: UsdaCommodityFindManySelectSchema.optional(),  orderBy: z.union([UsdaCommodityOrderByWithRelationInputObjectSchema, UsdaCommodityOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCommodityWhereInputObjectSchema.optional(), cursor: UsdaCommodityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCommodityScalarFieldEnumSchema, UsdaCommodityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaCommodityFindManyArgs>;

export const UsdaCommodityFindManyZodSchema = z.object({ select: UsdaCommodityFindManySelectSchema.optional(),  orderBy: z.union([UsdaCommodityOrderByWithRelationInputObjectSchema, UsdaCommodityOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCommodityWhereInputObjectSchema.optional(), cursor: UsdaCommodityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCommodityScalarFieldEnumSchema, UsdaCommodityScalarFieldEnumSchema.array()]).optional() }).strict();