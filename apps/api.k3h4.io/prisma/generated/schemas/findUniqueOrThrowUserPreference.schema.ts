...
export const UserPreferenceFindUniqueOrThrowSchema: z.ZodType<Prisma.UserPreferenceFindUniqueOrThrowArgs> = z.object({ select: UserPreferenceSelectObjectSchema.optional(), include: UserPreferenceIncludeObjectSchema.optional(), where: UserPreferenceWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.UserPreferenceFindUniqueOrThrowArgs>;

export const UserPreferenceFindUniqueOrThrowZodSchema = z.object({ select: UserPreferenceSelectObjectSchema.optional(), include: UserPreferenceIncludeObjectSchema.optional(), where: UserPreferenceWhereUniqueInputObjectSchema }).strict();