...
export const PoiFindFirstSelectSchema: z.ZodType<Prisma.PoiSelect> = z.object({
...
export const PoiFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    osmType: z.boolean().optional(),
    osmId: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const PoiFindFirstSchema: z.ZodType<Prisma.PoiFindFirstArgs> = z.object({ select: PoiFindFirstSelectSchema.optional(), include: z.lazy(() => PoiIncludeObjectSchema.optional()), orderBy: z.union([PoiOrderByWithRelationInputObjectSchema, PoiOrderByWithRelationInputObjectSchema.array()]).optional(), where: PoiWhereInputObjectSchema.optional(), cursor: PoiWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PoiScalarFieldEnumSchema, PoiScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PoiFindFirstArgs>;

export const PoiFindFirstZodSchema = z.object({ select: PoiFindFirstSelectSchema.optional(), include: z.lazy(() => PoiIncludeObjectSchema.optional()), orderBy: z.union([PoiOrderByWithRelationInputObjectSchema, PoiOrderByWithRelationInputObjectSchema.array()]).optional(), where: PoiWhereInputObjectSchema.optional(), cursor: PoiWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PoiScalarFieldEnumSchema, PoiScalarFieldEnumSchema.array()]).optional() }).strict();