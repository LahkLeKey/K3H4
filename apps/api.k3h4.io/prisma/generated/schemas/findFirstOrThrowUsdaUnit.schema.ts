...
export const UsdaUnitFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UsdaUnitSelect> = z.object({
...
export const UsdaUnitFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const UsdaUnitFindFirstOrThrowSchema: z.ZodType<Prisma.UsdaUnitFindFirstOrThrowArgs> = z.object({ select: UsdaUnitFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([UsdaUnitOrderByWithRelationInputObjectSchema, UsdaUnitOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaUnitWhereInputObjectSchema.optional(), cursor: UsdaUnitWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaUnitScalarFieldEnumSchema, UsdaUnitScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaUnitFindFirstOrThrowArgs>;

export const UsdaUnitFindFirstOrThrowZodSchema = z.object({ select: UsdaUnitFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([UsdaUnitOrderByWithRelationInputObjectSchema, UsdaUnitOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaUnitWhereInputObjectSchema.optional(), cursor: UsdaUnitWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaUnitScalarFieldEnumSchema, UsdaUnitScalarFieldEnumSchema.array()]).optional() }).strict();