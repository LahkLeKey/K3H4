...
export const PersonaCompatibilityFindFirstSelectSchema: z.ZodType<Prisma.PersonaCompatibilitySelect> = z.object({
...
export const PersonaCompatibilityFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    sourceId: z.boolean().optional(),
...
export const PersonaCompatibilityFindFirstSchema: z.ZodType<Prisma.PersonaCompatibilityFindFirstArgs> = z.object({ select: PersonaCompatibilityFindFirstSelectSchema.optional(), include: z.lazy(() => PersonaCompatibilityIncludeObjectSchema.optional()), orderBy: z.union([PersonaCompatibilityOrderByWithRelationInputObjectSchema, PersonaCompatibilityOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaCompatibilityWhereInputObjectSchema.optional(), cursor: PersonaCompatibilityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaCompatibilityScalarFieldEnumSchema, PersonaCompatibilityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PersonaCompatibilityFindFirstArgs>;

export const PersonaCompatibilityFindFirstZodSchema = z.object({ select: PersonaCompatibilityFindFirstSelectSchema.optional(), include: z.lazy(() => PersonaCompatibilityIncludeObjectSchema.optional()), orderBy: z.union([PersonaCompatibilityOrderByWithRelationInputObjectSchema, PersonaCompatibilityOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaCompatibilityWhereInputObjectSchema.optional(), cursor: PersonaCompatibilityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaCompatibilityScalarFieldEnumSchema, PersonaCompatibilityScalarFieldEnumSchema.array()]).optional() }).strict();