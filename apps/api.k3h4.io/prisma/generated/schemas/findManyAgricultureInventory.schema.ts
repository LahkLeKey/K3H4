...
export const AgricultureInventoryFindManySelectSchema: z.ZodType<Prisma.AgricultureInventorySelect> = z.object({
...
export const AgricultureInventoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    sku: z.boolean().optional(),
