...
export const ArcadeCardFindManySelectSchema: z.ZodType<Prisma.ArcadeCardSelect> = z.object({
...
export const ArcadeCardFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const ArcadeCardFindManySchema: z.ZodType<Prisma.ArcadeCardFindManyArgs> = z.object({ select: ArcadeCardFindManySelectSchema.optional(), include: z.lazy(() => ArcadeCardIncludeObjectSchema.optional()), orderBy: z.union([ArcadeCardOrderByWithRelationInputObjectSchema, ArcadeCardOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeCardWhereInputObjectSchema.optional(), cursor: ArcadeCardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeCardScalarFieldEnumSchema, ArcadeCardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeCardFindManyArgs>;

export const ArcadeCardFindManyZodSchema = z.object({ select: ArcadeCardFindManySelectSchema.optional(), include: z.lazy(() => ArcadeCardIncludeObjectSchema.optional()), orderBy: z.union([ArcadeCardOrderByWithRelationInputObjectSchema, ArcadeCardOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeCardWhereInputObjectSchema.optional(), cursor: ArcadeCardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeCardScalarFieldEnumSchema, ArcadeCardScalarFieldEnumSchema.array()]).optional() }).strict();