...
export const PersonaCompatibilityFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PersonaCompatibilitySelect> = z.object({
...
export const PersonaCompatibilityFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    sourceId: z.boolean().optional(),
...
export const PersonaCompatibilityFindFirstOrThrowSchema: z.ZodType<Prisma.PersonaCompatibilityFindFirstOrThrowArgs> = z.object({ select: PersonaCompatibilityFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PersonaCompatibilityIncludeObjectSchema.optional()), orderBy: z.union([PersonaCompatibilityOrderByWithRelationInputObjectSchema, PersonaCompatibilityOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaCompatibilityWhereInputObjectSchema.optional(), cursor: PersonaCompatibilityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaCompatibilityScalarFieldEnumSchema, PersonaCompatibilityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PersonaCompatibilityFindFirstOrThrowArgs>;

export const PersonaCompatibilityFindFirstOrThrowZodSchema = z.object({ select: PersonaCompatibilityFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PersonaCompatibilityIncludeObjectSchema.optional()), orderBy: z.union([PersonaCompatibilityOrderByWithRelationInputObjectSchema, PersonaCompatibilityOrderByWithRelationInputObjectSchema.array()]).optional(), where: PersonaCompatibilityWhereInputObjectSchema.optional(), cursor: PersonaCompatibilityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PersonaCompatibilityScalarFieldEnumSchema, PersonaCompatibilityScalarFieldEnumSchema.array()]).optional() }).strict();