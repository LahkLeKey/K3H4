...
export const GeoViewHistoryFindFirstSelectSchema: z.ZodType<Prisma.GeoViewHistorySelect> = z.object({
...
export const GeoViewHistoryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    signature: z.boolean().optional(),
...
export const GeoViewHistoryFindFirstSchema: z.ZodType<Prisma.GeoViewHistoryFindFirstArgs> = z.object({ select: GeoViewHistoryFindFirstSelectSchema.optional(), include: z.lazy(() => GeoViewHistoryIncludeObjectSchema.optional()), orderBy: z.union([GeoViewHistoryOrderByWithRelationInputObjectSchema, GeoViewHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoViewHistoryWhereInputObjectSchema.optional(), cursor: GeoViewHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoViewHistoryScalarFieldEnumSchema, GeoViewHistoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GeoViewHistoryFindFirstArgs>;

export const GeoViewHistoryFindFirstZodSchema = z.object({ select: GeoViewHistoryFindFirstSelectSchema.optional(), include: z.lazy(() => GeoViewHistoryIncludeObjectSchema.optional()), orderBy: z.union([GeoViewHistoryOrderByWithRelationInputObjectSchema, GeoViewHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: GeoViewHistoryWhereInputObjectSchema.optional(), cursor: GeoViewHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GeoViewHistoryScalarFieldEnumSchema, GeoViewHistoryScalarFieldEnumSchema.array()]).optional() }).strict();