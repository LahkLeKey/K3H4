...
export const UsdaSyncStateFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UsdaSyncStateSelect> = z.object({
...
export const UsdaSyncStateFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    scope: z.boolean().optional(),
    lastReleaseOn: z.boolean().optional(),
...
export const UsdaSyncStateFindFirstOrThrowSchema: z.ZodType<Prisma.UsdaSyncStateFindFirstOrThrowArgs> = z.object({ select: UsdaSyncStateFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([UsdaSyncStateOrderByWithRelationInputObjectSchema, UsdaSyncStateOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaSyncStateWhereInputObjectSchema.optional(), cursor: UsdaSyncStateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaSyncStateScalarFieldEnumSchema, UsdaSyncStateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaSyncStateFindFirstOrThrowArgs>;

export const UsdaSyncStateFindFirstOrThrowZodSchema = z.object({ select: UsdaSyncStateFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([UsdaSyncStateOrderByWithRelationInputObjectSchema, UsdaSyncStateOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaSyncStateWhereInputObjectSchema.optional(), cursor: UsdaSyncStateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaSyncStateScalarFieldEnumSchema, UsdaSyncStateScalarFieldEnumSchema.array()]).optional() }).strict();