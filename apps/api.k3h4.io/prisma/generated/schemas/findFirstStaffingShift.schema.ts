...
export const StaffingShiftFindFirstSelectSchema: z.ZodType<Prisma.StaffingShiftSelect> = z.object({
...
export const StaffingShiftFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    roleId: z.boolean().optional(),
...
export const StaffingShiftFindFirstSchema: z.ZodType<Prisma.StaffingShiftFindFirstArgs> = z.object({ select: StaffingShiftFindFirstSelectSchema.optional(), include: z.lazy(() => StaffingShiftIncludeObjectSchema.optional()), orderBy: z.union([StaffingShiftOrderByWithRelationInputObjectSchema, StaffingShiftOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingShiftWhereInputObjectSchema.optional(), cursor: StaffingShiftWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingShiftScalarFieldEnumSchema, StaffingShiftScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffingShiftFindFirstArgs>;

export const StaffingShiftFindFirstZodSchema = z.object({ select: StaffingShiftFindFirstSelectSchema.optional(), include: z.lazy(() => StaffingShiftIncludeObjectSchema.optional()), orderBy: z.union([StaffingShiftOrderByWithRelationInputObjectSchema, StaffingShiftOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingShiftWhereInputObjectSchema.optional(), cursor: StaffingShiftWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingShiftScalarFieldEnumSchema, StaffingShiftScalarFieldEnumSchema.array()]).optional() }).strict();