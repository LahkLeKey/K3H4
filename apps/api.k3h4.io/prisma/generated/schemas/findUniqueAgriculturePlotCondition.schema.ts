...
export const AgriculturePlotConditionFindUniqueSchema: z.ZodType<Prisma.AgriculturePlotConditionFindUniqueArgs> = z.object({ select: AgriculturePlotConditionSelectObjectSchema.optional(), include: AgriculturePlotConditionIncludeObjectSchema.optional(), where: AgriculturePlotConditionWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.AgriculturePlotConditionFindUniqueArgs>;

export const AgriculturePlotConditionFindUniqueZodSchema = z.object({ select: AgriculturePlotConditionSelectObjectSchema.optional(), include: AgriculturePlotConditionIncludeObjectSchema.optional(), where: AgriculturePlotConditionWhereUniqueInputObjectSchema }).strict();