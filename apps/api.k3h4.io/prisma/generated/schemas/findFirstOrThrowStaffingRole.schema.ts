...
export const StaffingRoleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StaffingRoleSelect> = z.object({
...
export const StaffingRoleFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    engagementId: z.boolean().optional(),
