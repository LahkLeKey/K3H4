...
export const StaffingShiftFindManySelectSchema: z.ZodType<Prisma.StaffingShiftSelect> = z.object({
...
export const StaffingShiftFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    roleId: z.boolean().optional(),
...
export const StaffingShiftFindManySchema: z.ZodType<Prisma.StaffingShiftFindManyArgs> = z.object({ select: StaffingShiftFindManySelectSchema.optional(), include: z.lazy(() => StaffingShiftIncludeObjectSchema.optional()), orderBy: z.union([StaffingShiftOrderByWithRelationInputObjectSchema, StaffingShiftOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingShiftWhereInputObjectSchema.optional(), cursor: StaffingShiftWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingShiftScalarFieldEnumSchema, StaffingShiftScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffingShiftFindManyArgs>;

export const StaffingShiftFindManyZodSchema = z.object({ select: StaffingShiftFindManySelectSchema.optional(), include: z.lazy(() => StaffingShiftIncludeObjectSchema.optional()), orderBy: z.union([StaffingShiftOrderByWithRelationInputObjectSchema, StaffingShiftOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffingShiftWhereInputObjectSchema.optional(), cursor: StaffingShiftWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffingShiftScalarFieldEnumSchema, StaffingShiftScalarFieldEnumSchema.array()]).optional() }).strict();