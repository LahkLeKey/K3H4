...
export const CulinaryMenuItemDeleteOneSchema: z.ZodType<Prisma.CulinaryMenuItemDeleteArgs> = z.object({ select: CulinaryMenuItemSelectObjectSchema.optional(), include: CulinaryMenuItemIncludeObjectSchema.optional(), where: CulinaryMenuItemWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.CulinaryMenuItemDeleteArgs>;

export const CulinaryMenuItemDeleteOneZodSchema = z.object({ select: CulinaryMenuItemSelectObjectSchema.optional(), include: CulinaryMenuItemIncludeObjectSchema.optional(), where: CulinaryMenuItemWhereUniqueInputObjectSchema }).strict();