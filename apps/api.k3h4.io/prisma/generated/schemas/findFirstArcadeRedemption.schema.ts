...
export const ArcadeRedemptionFindFirstSelectSchema: z.ZodType<Prisma.ArcadeRedemptionSelect> = z.object({
...
export const ArcadeRedemptionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    cardId: z.boolean().optional(),
...
export const ArcadeRedemptionFindFirstSchema: z.ZodType<Prisma.ArcadeRedemptionFindFirstArgs> = z.object({ select: ArcadeRedemptionFindFirstSelectSchema.optional(), include: z.lazy(() => ArcadeRedemptionIncludeObjectSchema.optional()), orderBy: z.union([ArcadeRedemptionOrderByWithRelationInputObjectSchema, ArcadeRedemptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeRedemptionWhereInputObjectSchema.optional(), cursor: ArcadeRedemptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeRedemptionScalarFieldEnumSchema, ArcadeRedemptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeRedemptionFindFirstArgs>;

export const ArcadeRedemptionFindFirstZodSchema = z.object({ select: ArcadeRedemptionFindFirstSelectSchema.optional(), include: z.lazy(() => ArcadeRedemptionIncludeObjectSchema.optional()), orderBy: z.union([ArcadeRedemptionOrderByWithRelationInputObjectSchema, ArcadeRedemptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeRedemptionWhereInputObjectSchema.optional(), cursor: ArcadeRedemptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeRedemptionScalarFieldEnumSchema, ArcadeRedemptionScalarFieldEnumSchema.array()]).optional() }).strict();