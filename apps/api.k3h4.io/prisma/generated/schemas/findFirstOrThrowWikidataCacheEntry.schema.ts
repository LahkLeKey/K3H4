...
export const WikidataCacheEntryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WikidataCacheEntrySelect> = z.object({
...
export const WikidataCacheEntryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    resource: z.boolean().optional(),
    endpoint: z.boolean().optional(),
    params: z.boolean().optional(),
...
export const WikidataCacheEntryFindFirstOrThrowSchema: z.ZodType<Prisma.WikidataCacheEntryFindFirstOrThrowArgs> = z.object({ select: WikidataCacheEntryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([WikidataCacheEntryOrderByWithRelationInputObjectSchema, WikidataCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WikidataCacheEntryWhereInputObjectSchema.optional(), cursor: WikidataCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WikidataCacheEntryScalarFieldEnumSchema, WikidataCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WikidataCacheEntryFindFirstOrThrowArgs>;

export const WikidataCacheEntryFindFirstOrThrowZodSchema = z.object({ select: WikidataCacheEntryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([WikidataCacheEntryOrderByWithRelationInputObjectSchema, WikidataCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WikidataCacheEntryWhereInputObjectSchema.optional(), cursor: WikidataCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WikidataCacheEntryScalarFieldEnumSchema, WikidataCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();