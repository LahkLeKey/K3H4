...
export const StaffingRoleFindFirstSelectSchema: z.ZodType<Prisma.StaffingRoleSelect> = z.object({
...
export const StaffingRoleFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    engagementId: z.boolean().optional(),
