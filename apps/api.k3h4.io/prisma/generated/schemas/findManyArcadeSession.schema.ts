...
export const ArcadeSessionFindManySelectSchema: z.ZodType<Prisma.ArcadeSessionSelect> = z.object({
...
export const ArcadeSessionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    machineId: z.boolean().optional(),
...
export const ArcadeSessionFindManySchema: z.ZodType<Prisma.ArcadeSessionFindManyArgs> = z.object({ select: ArcadeSessionFindManySelectSchema.optional(), include: z.lazy(() => ArcadeSessionIncludeObjectSchema.optional()), orderBy: z.union([ArcadeSessionOrderByWithRelationInputObjectSchema, ArcadeSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeSessionWhereInputObjectSchema.optional(), cursor: ArcadeSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeSessionScalarFieldEnumSchema, ArcadeSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeSessionFindManyArgs>;

export const ArcadeSessionFindManyZodSchema = z.object({ select: ArcadeSessionFindManySelectSchema.optional(), include: z.lazy(() => ArcadeSessionIncludeObjectSchema.optional()), orderBy: z.union([ArcadeSessionOrderByWithRelationInputObjectSchema, ArcadeSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeSessionWhereInputObjectSchema.optional(), cursor: ArcadeSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeSessionScalarFieldEnumSchema, ArcadeSessionScalarFieldEnumSchema.array()]).optional() }).strict();