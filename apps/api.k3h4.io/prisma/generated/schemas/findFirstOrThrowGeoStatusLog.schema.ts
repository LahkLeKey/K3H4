...
export const GeoStatusLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GeoStatusLogSelect> = z.object({
...
export const GeoStatusLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    status: z.boolean().optional(),
