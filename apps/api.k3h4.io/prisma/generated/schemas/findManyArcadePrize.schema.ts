...
export const ArcadePrizeFindManySelectSchema: z.ZodType<Prisma.ArcadePrizeSelect> = z.object({
...
export const ArcadePrizeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const ArcadePrizeFindManySchema: z.ZodType<Prisma.ArcadePrizeFindManyArgs> = z.object({ select: ArcadePrizeFindManySelectSchema.optional(), include: z.lazy(() => ArcadePrizeIncludeObjectSchema.optional()), orderBy: z.union([ArcadePrizeOrderByWithRelationInputObjectSchema, ArcadePrizeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadePrizeWhereInputObjectSchema.optional(), cursor: ArcadePrizeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadePrizeScalarFieldEnumSchema, ArcadePrizeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadePrizeFindManyArgs>;

export const ArcadePrizeFindManyZodSchema = z.object({ select: ArcadePrizeFindManySelectSchema.optional(), include: z.lazy(() => ArcadePrizeIncludeObjectSchema.optional()), orderBy: z.union([ArcadePrizeOrderByWithRelationInputObjectSchema, ArcadePrizeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadePrizeWhereInputObjectSchema.optional(), cursor: ArcadePrizeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadePrizeScalarFieldEnumSchema, ArcadePrizeScalarFieldEnumSchema.array()]).optional() }).strict();