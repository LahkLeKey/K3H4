...
export const ArcadeRedemptionFindManySelectSchema: z.ZodType<Prisma.ArcadeRedemptionSelect> = z.object({
...
export const ArcadeRedemptionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    cardId: z.boolean().optional(),
