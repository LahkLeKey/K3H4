...
export const AgricultureShipmentFindFirstSelectSchema: z.ZodType<Prisma.AgricultureShipmentSelect> = z.object({
...
export const AgricultureShipmentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    lot: z.boolean().optional(),
...
export const AgricultureShipmentFindFirstSchema: z.ZodType<Prisma.AgricultureShipmentFindFirstArgs> = z.object({ select: AgricultureShipmentFindFirstSelectSchema.optional(), include: z.lazy(() => AgricultureShipmentIncludeObjectSchema.optional()), orderBy: z.union([AgricultureShipmentOrderByWithRelationInputObjectSchema, AgricultureShipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureShipmentWhereInputObjectSchema.optional(), cursor: AgricultureShipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureShipmentScalarFieldEnumSchema, AgricultureShipmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgricultureShipmentFindFirstArgs>;

export const AgricultureShipmentFindFirstZodSchema = z.object({ select: AgricultureShipmentFindFirstSelectSchema.optional(), include: z.lazy(() => AgricultureShipmentIncludeObjectSchema.optional()), orderBy: z.union([AgricultureShipmentOrderByWithRelationInputObjectSchema, AgricultureShipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureShipmentWhereInputObjectSchema.optional(), cursor: AgricultureShipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureShipmentScalarFieldEnumSchema, AgricultureShipmentScalarFieldEnumSchema.array()]).optional() }).strict();