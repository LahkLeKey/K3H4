...
export const MaptilerQueryCountOutputTypeCountCacheEntriesArgsObjectSchema = makeSchema();
export const MaptilerQueryCountOutputTypeCountCacheEntriesArgsObjectZodSchema = makeSchema();
