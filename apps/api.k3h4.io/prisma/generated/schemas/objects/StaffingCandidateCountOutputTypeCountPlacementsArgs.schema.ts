...
export const StaffingCandidateCountOutputTypeCountPlacementsArgsObjectSchema = makeSchema();
export const StaffingCandidateCountOutputTypeCountPlacementsArgsObjectZodSchema = makeSchema();
