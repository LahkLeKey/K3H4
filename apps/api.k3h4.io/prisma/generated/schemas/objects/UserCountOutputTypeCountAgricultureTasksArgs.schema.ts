...
export const UserCountOutputTypeCountAgricultureTasksArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountAgricultureTasksArgsObjectZodSchema = makeSchema();
