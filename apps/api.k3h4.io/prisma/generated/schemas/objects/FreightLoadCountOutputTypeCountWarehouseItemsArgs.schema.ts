...
export const FreightLoadCountOutputTypeCountWarehouseItemsArgsObjectSchema = makeSchema();
export const FreightLoadCountOutputTypeCountWarehouseItemsArgsObjectZodSchema = makeSchema();
