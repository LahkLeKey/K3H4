...
const makeSchema = () => z.object({
  ...
  inputPoints: z.literal(true).optional(),
  ...
  routeCacheId: z.literal(true).optional(),
  createdAt: z.literal(true).optional(),
  updatedAt: z.literal(true).optional(),
  _all: z.literal(true).optional()
}).strict();
export const GeoDirectionCountAggregateInputObjectSchema: z.ZodType<Prisma.GeoDirectionCountAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.GeoDirectionCountAggregateInputType>;
export const GeoDirectionCountAggregateInputObjectZodSchema = makeSchema();
