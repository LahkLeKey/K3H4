...
export const UserCountOutputTypeCountAgricultureInventoryMovementsArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountAgricultureInventoryMovementsArgsObjectZodSchema = makeSchema();
