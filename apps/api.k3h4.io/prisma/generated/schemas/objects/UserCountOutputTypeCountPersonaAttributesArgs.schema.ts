...
export const UserCountOutputTypeCountPersonaAttributesArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountPersonaAttributesArgsObjectZodSchema = makeSchema();
