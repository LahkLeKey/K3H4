...
export const UserCountOutputTypeCountStaffingRolesArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountStaffingRolesArgsObjectZodSchema = makeSchema();
