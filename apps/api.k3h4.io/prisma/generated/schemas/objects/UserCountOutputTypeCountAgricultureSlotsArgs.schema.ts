...
export const UserCountOutputTypeCountAgricultureSlotsArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountAgricultureSlotsArgsObjectZodSchema = makeSchema();
