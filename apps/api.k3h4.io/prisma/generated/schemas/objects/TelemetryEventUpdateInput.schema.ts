...
import { UserUpdateOneWithoutTelemetryNestedInputObjectSchema as UserUpdateOneWithoutTelemetryNestedInputObjectSchema } from './UserUpdateOneWithoutTelemetryNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  user: z.lazy(() => UserUpdateOneWithoutTelemetryNestedInputObjectSchema).optional()
}).strict();
export const TelemetryEventUpdateInputObjectSchema: z.ZodType<Prisma.TelemetryEventUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.TelemetryEventUpdateInput>;
export const TelemetryEventUpdateInputObjectZodSchema = makeSchema();
