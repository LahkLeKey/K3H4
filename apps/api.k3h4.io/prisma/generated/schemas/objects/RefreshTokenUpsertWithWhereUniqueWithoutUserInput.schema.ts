...
const makeSchema = () => z.object({
  ...
  update: z.union([z.lazy(() => RefreshTokenUpdateWithoutUserInputObjectSchema), z.lazy(() => RefreshTokenUncheckedUpdateWithoutUserInputObjectSchema)]),
  create: z.union([z.lazy(() => RefreshTokenCreateWithoutUserInputObjectSchema), z.lazy(() => RefreshTokenUncheckedCreateWithoutUserInputObjectSchema)])
}).strict();
export const RefreshTokenUpsertWithWhereUniqueWithoutUserInputObjectSchema: z.ZodType<Prisma.RefreshTokenUpsertWithWhereUniqueWithoutUserInput> = makeSchema() as unknown as z.ZodType<Prisma.RefreshTokenUpsertWithWhereUniqueWithoutUserInput>;
export const RefreshTokenUpsertWithWhereUniqueWithoutUserInputObjectZodSchema = makeSchema();
