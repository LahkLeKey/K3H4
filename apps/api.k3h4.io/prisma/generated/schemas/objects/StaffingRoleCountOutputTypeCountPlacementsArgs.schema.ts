...
export const StaffingRoleCountOutputTypeCountPlacementsArgsObjectSchema = makeSchema();
export const StaffingRoleCountOutputTypeCountPlacementsArgsObjectZodSchema = makeSchema();
