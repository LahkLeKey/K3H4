...
export const ArcadeMachineCountOutputTypeCountSessionsArgsObjectSchema = makeSchema();
export const ArcadeMachineCountOutputTypeCountSessionsArgsObjectZodSchema = makeSchema();
