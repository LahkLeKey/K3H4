...
const geodemtilecachewhereinputSchema = z.object({
  AND: z.union([z.lazy(() => GeoDemTileCacheWhereInputObjectSchema), z.lazy(() => GeoDemTileCacheWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => GeoDemTileCacheWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => GeoDemTileCacheWhereInputObjectSchema), z.lazy(() => GeoDemTileCacheWhereInputObjectSchema).array()]).optional(),
...
export const GeoDemTileCacheWhereInputObjectSchema: z.ZodType<Prisma.GeoDemTileCacheWhereInput> = geodemtilecachewhereinputSchema as unknown as z.ZodType<Prisma.GeoDemTileCacheWhereInput>;
export const GeoDemTileCacheWhereInputObjectZodSchema = geodemtilecachewhereinputSchema;
