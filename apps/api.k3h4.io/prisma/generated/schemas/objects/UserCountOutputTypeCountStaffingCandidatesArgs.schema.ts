...
export const UserCountOutputTypeCountStaffingCandidatesArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountStaffingCandidatesArgsObjectZodSchema = makeSchema();
