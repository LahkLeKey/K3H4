...
export const UsdaCacheEntryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UsdaCacheEntrySelect> = z.object({
...
export const UsdaCacheEntryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    dataset: z.boolean().optional(),
    endpoint: z.boolean().optional(),
    params: z.boolean().optional(),
...
export const UsdaCacheEntryFindFirstOrThrowSchema: z.ZodType<Prisma.UsdaCacheEntryFindFirstOrThrowArgs> = z.object({ select: UsdaCacheEntryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([UsdaCacheEntryOrderByWithRelationInputObjectSchema, UsdaCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCacheEntryWhereInputObjectSchema.optional(), cursor: UsdaCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCacheEntryScalarFieldEnumSchema, UsdaCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsdaCacheEntryFindFirstOrThrowArgs>;

export const UsdaCacheEntryFindFirstOrThrowZodSchema = z.object({ select: UsdaCacheEntryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([UsdaCacheEntryOrderByWithRelationInputObjectSchema, UsdaCacheEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsdaCacheEntryWhereInputObjectSchema.optional(), cursor: UsdaCacheEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsdaCacheEntryScalarFieldEnumSchema, UsdaCacheEntryScalarFieldEnumSchema.array()]).optional() }).strict();