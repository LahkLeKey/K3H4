...
export const AgriculturePlotFindFirstSelectSchema: z.ZodType<Prisma.AgriculturePlotSelect> = z.object({
...
export const AgriculturePlotFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const AgriculturePlotFindFirstSchema: z.ZodType<Prisma.AgriculturePlotFindFirstArgs> = z.object({ select: AgriculturePlotFindFirstSelectSchema.optional(), include: z.lazy(() => AgriculturePlotIncludeObjectSchema.optional()), orderBy: z.union([AgriculturePlotOrderByWithRelationInputObjectSchema, AgriculturePlotOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgriculturePlotWhereInputObjectSchema.optional(), cursor: AgriculturePlotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgriculturePlotScalarFieldEnumSchema, AgriculturePlotScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgriculturePlotFindFirstArgs>;

export const AgriculturePlotFindFirstZodSchema = z.object({ select: AgriculturePlotFindFirstSelectSchema.optional(), include: z.lazy(() => AgriculturePlotIncludeObjectSchema.optional()), orderBy: z.union([AgriculturePlotOrderByWithRelationInputObjectSchema, AgriculturePlotOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgriculturePlotWhereInputObjectSchema.optional(), cursor: AgriculturePlotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgriculturePlotScalarFieldEnumSchema, AgriculturePlotScalarFieldEnumSchema.array()]).optional() }).strict();