...
export const UserPreferenceFindFirstSelectSchema: z.ZodType<Prisma.UserPreferenceSelect> = z.object({
...
export const UserPreferenceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    theme: z.boolean().optional(),
...
export const UserPreferenceFindFirstSchema: z.ZodType<Prisma.UserPreferenceFindFirstArgs> = z.object({ select: UserPreferenceFindFirstSelectSchema.optional(), include: z.lazy(() => UserPreferenceIncludeObjectSchema.optional()), orderBy: z.union([UserPreferenceOrderByWithRelationInputObjectSchema, UserPreferenceOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserPreferenceWhereInputObjectSchema.optional(), cursor: UserPreferenceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserPreferenceScalarFieldEnumSchema, UserPreferenceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserPreferenceFindFirstArgs>;

export const UserPreferenceFindFirstZodSchema = z.object({ select: UserPreferenceFindFirstSelectSchema.optional(), include: z.lazy(() => UserPreferenceIncludeObjectSchema.optional()), orderBy: z.union([UserPreferenceOrderByWithRelationInputObjectSchema, UserPreferenceOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserPreferenceWhereInputObjectSchema.optional(), cursor: UserPreferenceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserPreferenceScalarFieldEnumSchema, UserPreferenceScalarFieldEnumSchema.array()]).optional() }).strict();