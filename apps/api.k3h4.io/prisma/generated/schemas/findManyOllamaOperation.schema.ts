...
export const OllamaOperationFindManySelectSchema: z.ZodType<Prisma.OllamaOperationSelect> = z.object({
...
export const OllamaOperationFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    source: z.boolean().optional(),
