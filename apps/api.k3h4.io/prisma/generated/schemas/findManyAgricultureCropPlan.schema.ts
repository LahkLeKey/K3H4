...
export const AgricultureCropPlanFindManySelectSchema: z.ZodType<Prisma.AgricultureCropPlanSelect> = z.object({
...
export const AgricultureCropPlanFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    plotId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const AgricultureCropPlanFindManySchema: z.ZodType<Prisma.AgricultureCropPlanFindManyArgs> = z.object({ select: AgricultureCropPlanFindManySelectSchema.optional(), include: z.lazy(() => AgricultureCropPlanIncludeObjectSchema.optional()), orderBy: z.union([AgricultureCropPlanOrderByWithRelationInputObjectSchema, AgricultureCropPlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureCropPlanWhereInputObjectSchema.optional(), cursor: AgricultureCropPlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureCropPlanScalarFieldEnumSchema, AgricultureCropPlanScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgricultureCropPlanFindManyArgs>;

export const AgricultureCropPlanFindManyZodSchema = z.object({ select: AgricultureCropPlanFindManySelectSchema.optional(), include: z.lazy(() => AgricultureCropPlanIncludeObjectSchema.optional()), orderBy: z.union([AgricultureCropPlanOrderByWithRelationInputObjectSchema, AgricultureCropPlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgricultureCropPlanWhereInputObjectSchema.optional(), cursor: AgricultureCropPlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgricultureCropPlanScalarFieldEnumSchema, AgricultureCropPlanScalarFieldEnumSchema.array()]).optional() }).strict();