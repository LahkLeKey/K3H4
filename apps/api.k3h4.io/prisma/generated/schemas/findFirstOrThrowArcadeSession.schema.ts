...
export const ArcadeSessionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArcadeSessionSelect> = z.object({
...
export const ArcadeSessionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    machineId: z.boolean().optional(),
...
export const ArcadeSessionFindFirstOrThrowSchema: z.ZodType<Prisma.ArcadeSessionFindFirstOrThrowArgs> = z.object({ select: ArcadeSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeSessionIncludeObjectSchema.optional()), orderBy: z.union([ArcadeSessionOrderByWithRelationInputObjectSchema, ArcadeSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeSessionWhereInputObjectSchema.optional(), cursor: ArcadeSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeSessionScalarFieldEnumSchema, ArcadeSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArcadeSessionFindFirstOrThrowArgs>;

export const ArcadeSessionFindFirstOrThrowZodSchema = z.object({ select: ArcadeSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArcadeSessionIncludeObjectSchema.optional()), orderBy: z.union([ArcadeSessionOrderByWithRelationInputObjectSchema, ArcadeSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArcadeSessionWhereInputObjectSchema.optional(), cursor: ArcadeSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArcadeSessionScalarFieldEnumSchema, ArcadeSessionScalarFieldEnumSchema.array()]).optional() }).strict();